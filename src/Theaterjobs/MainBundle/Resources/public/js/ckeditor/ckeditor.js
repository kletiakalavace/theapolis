    ...
    window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function () {
            ...
            return {
                define: function (b, d) {
                    ...
                    if (0 > g.getListenerIndex(d)) {
                        ...
                        h.fn = d;
                        h.priority = f;
                        for (var v = g.length - 1; 0 <= v; v--)if (g[v].priority <= f)return g.splice(v + 1, 0, h), {removeListener: k};
                        g.unshift(h)
                    }
                    ...
                    return function (f, h, k) {
                        ...
                        if (g) {
                            var v = g.listeners;
                            if (v.length)for (var v = v.slice(0), r, q = 0; q < v.length; q++) {
                                if (g.errorProof)try {
                                    r = v[q].call(this, k, h, b, m)
                                } catch (t) {
                                } else r = v[q].call(this, k, h, b, m);
        ...
        CKEDITOR.tools = {
            ...
            getIndex: function (a, g) {
                for (var f =
                    0; f < a.length; ++f)if (g(a[f]))return f;
                return -1
            },
            clone: function (a) {
                var g;
            ...
            buildStyleHtml: function (a) {
                a = [].concat(a);
                for (var g, f = [], b = 0; b < a.length; b++)if (g = a[b]) /@import|[{}]/.test(g) ? f.push("\x3cstyle\x3e" +
                        g + "\x3c/style\x3e") : f.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + g + '"\x3e');
                return f.join("")
            },
            ...
            transformPlainTextToHtml: function (a, g) {
                ...
                if (!f) {
                    var c = /\n{2}/g;
                    if (c.test(b))var d = "\x3c" + h + "\x3e", e = "\x3c/" + h + "\x3e", b = d + b.replace(c, function () {
                            return e + d
                        }) + e
                }
                b = b.replace(/\n/g, "\x3cbr\x3e");
            ...
            createClass: function (a) {
                var g = a.$, f = a.base, b = a.privates || a._, h = a.proto;
                a = a.statics;
                !g && (g = function () {
            ...
            normalizeCssText: function (a, g) {
                var f = [], b, h = CKEDITOR.tools.parseCssText(a, !0, g);
            ...
            checkIfAnyArrayItemMatches: function (a, g) {
                for (var f = 0, b = a.length; f < b; ++f)if (a[f].match(g))return !0;
                return !1
            },
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var g = document.cookie.split(";"), f, b, h = 0; h < g.length; h++)if (f = g[h].split("\x3d"),
                        b = decodeURIComponent(CKEDITOR.tools.trim(f[0]).toLowerCase()), b === a)return decodeURIComponent(1 < f.length ? f[1] : "");
                return null
            },
            ...
            getCsrfToken: function () {
                ...
                if (!a || 40 != a.length) {
                    var a = [], g = "";
                    if (window.crypto && window.crypto.getRandomValues) a = new Uint8Array(40), window.crypto.getRandomValues(a); else for (var f = 0; 40 > f; f++)a.push(Math.floor(256 * Math.random()));
                    for (f = 0; f < a.length; f++)var b = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[f] % 36), g = g + (.5 < Math.random() ? b.toUpperCase() : b);
                    a = g;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            type: CKEDITOR.NODE_ELEMENT, addClass: d ? function (a) {
                    ...
                    b && a(b, f) && ((b = b.replace(new RegExp("(?:^|\\s+)" + f + "(?\x3d\\s|$)"), "").replace(/^\s+/, "")) ? this.setAttribute("class",
            ...
            getTabIndex: function () {
                ...
                function a(b, f, g) {
                    if (f && f.type == CKEDITOR.NODE_ELEMENT) {
                        for (var c = []; f.data("cke-bookmark") || f.isEmptyInlineRemoveable();)if (c.push(f),
                                f = g ? f.getNext() : f.getPrevious(), !f || f.type != CKEDITOR.NODE_ELEMENT)return;
                        if (b.isIdentical(f)) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var l = this.$.getBoundingClientRect(), m = g.$.documentElement, t = m.clientTop || d.$.clientTop || 0, p = m.clientLeft || d.$.clientLeft || 0, w = !0;
                    CKEDITOR.env.ie && (w = g.getDocumentElement().contains(this), g = g.getBody().contains(this), w = e && g || !e && w);
                    w && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || m.scrollLeft, c = d.$.scrollTop || m.scrollTop) : (c = e ? d.$ : m, b = c.scrollLeft, c = c.scrollTop), b = l.left + b - p, c = l.top + c - t)
                } else for (t = this, p = null; t && "body" != t.getName() &&
                "html" != t.getName();) {
                ...
                e = a.getWindow();
                d = t(this, e);
                var z = t(a, e), A = this.$.offsetHeight;
                g = this.$.offsetWidth;
                var u = a.$.clientHeight, x = a.$.clientWidth;
                e = d.x - p(this, "left") - z.x || 0;
                l = d.y - p(this, "top") - z.y || 0;
                g = d.x + g + p(this, "right") - (z.x + x) || 0;
                d = d.y + A + p(this, "bottom") - (z.y + u) || 0;
            ...
            getFrameDocument: function () {
                ...
                var b = CKEDITOR.instances, c, g, d;
                a = a || void 0 === a;
                for (c in b)if (g = b[c], g.element.equals(this) && g.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || !a && (d = g.editable(), d.equals(this) || d.contains(this)))return g;
                return null
            }, find: function (a) {
                var c = e(this);
        ...
        function a(a, b) {
            ...
            c = g.endContainer;
            var f = g.startOffset, k = g.endOffset, h, e = this.guard, n = this.type, l = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var m = c.type == CKEDITOR.NODE_ELEMENT ? c : c.getParent(), B = c.type == CKEDITOR.NODE_ELEMENT ? c.getChild(k) : c.getNext();
            ...
            if (a && !this._.guardRTL) {
                var C = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), F = d.type == CKEDITOR.NODE_ELEMENT ? f ? d.getChild(f - 1) : null : d.getPrevious();
            ...
            this.current ? c = this.current[l](!1,
                    n, h) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < k ? c.getChild(k - 1) : !1 === h(c, !0) ? null : c.getPreviousSourceNode(!0, n, h)) : (c = d, c.type == CKEDITOR.NODE_ELEMENT && ((c = c.getChild(f)) || (c = !1 === h(d, !0) ? null : d.getNextSourceNode(!0, n, h)))), c && !1 === h(c) && (c = null));
            for (; c && !this._.end;) {
                this.current = c;
        ...
        function e(a, b, c, d, f) {
            function k(a, b, g, c) {
                ...
                if (c && l)return d;
                u || c ? b.append(a.clone(!0, f), g) : (a.remove(), m && b.append(a));
                return d
            }
            ...
            function h() {
                var a, b, g, c = Math.min(I.length,
                    H.length);
                for (a = 0; a < c; a++)if (b = I[a], g = H[a], !b.equals(g))return a;
                return a - 1
            }

            function e() {
                var b = R - 1, c = E && J && !x.equals(D);
                b < P - 1 || b < T - 1 || c ? (c ? a.moveToPosition(D, CKEDITOR.POSITION_BEFORE_START) : T == b + 1 && F ? a.moveToPosition(H[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(H[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = I[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b),
                        b.mergeSiblings(!1), a.moveToBookmark({startNode: c}))) : a.collapse(!0)
            }

            a.optimizeBookmark();
            var l = 0 === b, m = 1 == b, u = 2 == b;
            b = u || m;
            var x = a.startContainer, D = a.endContainer, y = a.startOffset, B = a.endOffset, C, F, E, J, G, M;
            if (u && D.type == CKEDITOR.NODE_TEXT && x.equals(D)) x = a.document.createText(x.substring(y, B)), c.append(x); else {
                D.type == CKEDITOR.NODE_TEXT ? u ? M = !0 : D = D.split(B) : 0 < D.getChildCount() ? B >= D.getChildCount() ? (D = D.getChild(B - 1), F = !0) : D = D.getChild(B) : J = F = !0;
                x.type == CKEDITOR.NODE_TEXT ? u ? G = !0 : x.split(y) : 0 < x.getChildCount() ?
                        0 === y ? (x = x.getChild(y), C = !0) : x = x.getChild(y - 1) : E = C = !0;
                for (var I = x.getParents(), H = D.getParents(), R = h(), P = I.length - 1, T = H.length - 1, O = c, K, ca, W, U = -1, L = R; L <= P; L++) {
                    ca = I[L];
                    W = ca.getNext();
                    for (L != P || ca.equals(H[L]) && P < T ? b && (K = O.append(ca.clone(0, f))) : C ? k(ca, O, !1, E) : G && O.append(a.document.createText(ca.substring(y))); W;) {
                        if (W.equals(H[L])) {
                            U = L;
                            break
                        }
                ...
                O = c;
                for (L = R; L <= T; L++)if (c = H[L], W = c.getPrevious(), c.equals(I[L])) b && (O = O.getChild(0)); else {
                    L != T || c.equals(I[L]) && T < P ? b && (K = O.append(c.clone(0, f))) :
                        F ? k(c, O, !1, J) : M && O.append(a.document.createText(c.substring(0, B)));
                    if (L > U)for (; W;)W = k(W, O, !0);
                    O = K
                }
                u || e()
            }
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var h = this.getCommonAncestor(), e = this.root, l, m, u, x, D, y = !1, B, C;
                        B = this.startContainer;
                        var F = this.startOffset;
                        B.type == CKEDITOR.NODE_TEXT ? (F && (B = !CKEDITOR.tools.trim(B.substring(0, F)).length &&
                                B, y = !!B), B && ((x = B.getPrevious()) || (u = B.getParent()))) : (F && (x = B.getChild(F - 1) || B.getLast()), x || (u = B));
                        for (u = c(u); u || x;) {
                            if (u && !x) {
                                !D && u.equals(h) && (D = !0);
                                if (f ? u.isBlockBoundary() : !e.contains(u))break;
                                y && "inline" == u.getComputedStyle("display") || (y = !1, D ? l = u : this.setStartBefore(u));
                                x = u.getPrevious()
                            }
                            for (; x;)if (B = !1, x.type == CKEDITOR.NODE_COMMENT) x = x.getPrevious(); else {
                                if (x.type == CKEDITOR.NODE_TEXT) C = x.getText(), d.test(C) && (x = null), B = /[\s\ufeff]$/.test(C); else if ((x.$.offsetWidth > (CKEDITOR.env.webkit ? 1 :
                                        0) || b && x.is("br")) && !x.data("cke-bookmark"))if (y && CKEDITOR.dtd.$removeEmpty[x.getName()]) {
                                    C = x.getText();
                                    if (d.test(C)) x = null; else for (var F = x.$.getElementsByTagName("*"), E = 0, J; J = F[E++];)if (!CKEDITOR.dtd.$removeEmpty[J.nodeName.toLowerCase()]) {
                                        x = null;
                                        break
                                    }
                                    x && (B = !!C.length)
                                } else x = null;
                                B && (y ? D ? l = u : u && this.setStartBefore(u) : y = !0);
                                if (x) {
                                    B = x.getPrevious();
                                    if (!u && !B) {
                                        u = x;
                        ...
                        B.type == CKEDITOR.NODE_TEXT ?
                            CKEDITOR.tools.trim(B.substring(F)).length ? y = !0 : (y = !B.getLength(), F == B.getLength() ? (x = B.getNext()) || (u = B.getParent()) : k(B, F) && (u = B.getParent())) : (x = B.getChild(F)) || (u = B);
                        for (; u || x;) {
                            if (u && !x) {
                                !D && u.equals(h) && (D = !0);
                                if (f ? u.isBlockBoundary() : !e.contains(u))break;
                                y && "inline" == u.getComputedStyle("display") || (y = !1, D ? m = u : u && this.setEndAfter(u));
                                x = u.getNext()
                            }
                            for (; x;) {
                                B = !1;
                                if (x.type == CKEDITOR.NODE_TEXT) C = x.getText(), k(x, 0) || (x = null), B = /^[\s\ufeff]/.test(C); else if (x.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < x.$.offsetWidth ||
                                        b && x.is("br")) && !x.data("cke-bookmark"))if (y && CKEDITOR.dtd.$removeEmpty[x.getName()]) {
                                        C = x.getText();
                                        if (d.test(C)) x = null; else for (F = x.$.getElementsByTagName("*"), E = 0; J = F[E++];)if (!CKEDITOR.dtd.$removeEmpty[J.nodeName.toLowerCase()]) {
                                            x = null;
                                            break
                                        }
                                        x && (B = !!C.length)
                        ...
                        l && m && (h = l.contains(m) ? m : l, this.setStartBefore(h), this.setEndAfter(h));
                        break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var G, M, I = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), H = null, R = function (a) {
                        ...
                        u = u.lastBackward();
                        G = G || e;
                        this.setStartAt(G, !G.is("br") && (!u && this.checkStartOfBlock() || u && G.contains(u)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        ...
                        u = u.lastForward();
                        G = G || e;
                        this.setEndAt(G, !u && this.checkEndOfBlock() || u && G.contains(u) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
                        M && this.setEndAfter(M)
                }
            }, shrink: function (a, b, c) {
                if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT;
                    var d = this.clone(), f = this.startContainer, k = this.endContainer, h = this.startOffset, e = this.endOffset, l = 1, m = 1;
                    f && f.type == CKEDITOR.NODE_TEXT && (h ?
                        h >= f.getLength() ? d.setStartAfter(f) : (d.setStartBefore(f), l = 0) : d.setStartBefore(f));
                    k && k.type == CKEDITOR.NODE_TEXT && (e ? e >= k.getLength() ? d.setEndAfter(k) : (d.setEndAfter(k), m = 0) : d.setEndBefore(k));
            ...
            setStart: function (b, c) {
                ...
                "br" != a && (f || (f = this.fixBlock(!0, a), k = (new CKEDITOR.dom.elementPath(this.endContainer,
            ...
            moveToElementEditEnd: function (a) {
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), f = [], k, h, e, l;
                if (c && c.find)for (h = c.find(a), k = 0; k < h.count(); k++)if (c = h.getItem(k), b || !c.isReadOnly()) e = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING ||
                    d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED, e && l && f.push(c);
                return f
            }
        }
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    e = t.startPath();
                    var p = t.endPath(), w = !t.collapsed && c(t, e.block), z = !t.collapsed && c(t, p.block, 1);
                    t.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    w && t.setStartAt(e.block, CKEDITOR.POSITION_BEFORE_END);
                    z && t.setEndAt(p.block, CKEDITOR.POSITION_AFTER_START);
                    ...
                    t.collapsed || (e = new CKEDITOR.dom.walker(t.clone()),
                        ...
                        p.root), this._.lastNode = (p.block || p.blockLimit).getNextSourceNode(!0))), this._.lastNode && t.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = t.document.createText(""), this._.lastNode.insertAfter(e)), t = null);
                    this._.started = 1;
                    e = t
                }
                p = this._.nextNode;
                ...
                for (this._.nextNode = null; p;) {
                    var w = 0, z = p.hasAscendant("pre"), A = p.type != CKEDITOR.NODE_ELEMENT, u = 0;
                    if (A) p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (A = 0); else {
                        var x = p.getName();
                        if (CKEDITOR.dtd.$block[x] && "false" == p.getAttribute("contenteditable")) {
                            g =
                                p;
                            b(this, a, g);
                            break
                            ...
                            e && (e.setEndAt(p, CKEDITOR.POSITION_BEFORE_START), "br" != x && (this._.nextNode = p));
                            w = 1
                        } else {
                            if (p.getFirst()) {
                    ...
                    m = (!w || A) && p.equals(t);
                    if (e && !w)for (; !p.getNext(f) && !m;) {
                        x =
                            p.getParent();
                        if (x.isBlockBoundary(this.forceBrBreak && !z && {br: 1})) {
                            w = 1;
                            A = 0;
                            m || x.equals(t);
                            e.setEndAt(x, CKEDITOR.POSITION_BEFORE_END);
                            break
                        }
                        p = x;
                        A = 1;
                    ...
                    A && e.setEndAt(p, CKEDITOR.POSITION_AFTER_END);
                    p = this._getNextSourceNode(p, u, t);
                    if ((m = !p) || w && e)break
                }
                if (!g) {
                    ...
                    w = {div: 1, th: 1, td: 1};
                    g = g.block;
                    !g && p && !this.enforceRealBlocks && w[p.getName()] &&
                ...
                r && (r =
                    g.getPrevious()) && r.type == CKEDITOR.NODE_ELEMENT && ("br" == r.getName() ? r.remove() : r.getLast() && "br" == r.getLast().$.nodeName.toLowerCase() && r.getLast().remove());
                q && (r = g.getLast()) && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() && (!CKEDITOR.env.needsBrFiller || r.getPrevious(l) || r.getNext(l)) && r.remove();
        ...
        function a(a, b, c, d, f) {
            ...
            for (g in b) {
                e = b[g];
                e = "boolean" == typeof e ? {} : "function" == typeof e ? {match: e} : E(e);
                ...
                for (l in M) {
                    k[l] = m(k[l],
                            h) || null;
                    var u = k, t = I[l], x = m(k[I[l]], h), A = k[l], p = [], D = !0, n = void 0;
                    x ? D = !1 : x = {};
                    for (n in A)"!" == n.charAt(0) && (n = n.slice(1), p.push(n), x[n] = !0, D = !1);
                    for (; n = p.pop();)A[n] = A["!" + n], delete A["!" + n];
                    u[t] = (D ? !1 : x) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (l in I) {
                    ...
                    x = [];
                    A = void 0;
                    for (A in t)-1 < A.indexOf("*") ? x.push(new RegExp("^" +
                            A.replace(/\*/g, ".*") + "$")) : x.push(A);
                    t = x;
                    t.length && (k[h] = t, u = !1)
                }
                k.nothingRequired = u;
                k.noProperties = !(k.attributes || k.classes || k.styles);
                if (!0 === g.elements || null === g.elements) f[e ? "unshift" : "push"](g); else for (H in k = g.elements, delete g.elements, k)if (b[H]) b[H][e ? "unshift" : "push"](g); else b[H] = [g]
            }
        }
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var f = !1, g = !0 === a, e = b.length; e--;)if (g || a(b[e])) b.splice(e, 1), f = !0;
                    a = f
                } else a = !1;
        ...
        function g(a) {
            var b, c, d, f, g = {}, e = 1;
            for (a = J(a); b = a.match(H);)(c = b[2]) ? (d = n(c, "styles"), f = n(c, "attrs"), c = n(c, "classes")) : d = f = c = null, g["$" + e++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: f
        ...
        function r(a, b, d, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var h = 0, l = k.length, u; h < l; ++h)if (u = k[h](b)) {
                        k = u;
                        break a
                    }
                    k = void 0
            ...
            if (f.doTransform && (k = a._.transformations[b.name])) {
                v(b);
                for (h = 0; h < k.length; ++h)x(a, b, k[h]);
                t(b)
            }
            if (f.doFilter) {
                a:{
                    h =
                        b.name;
                    l = a._;
                    a = l.allowedRules.elements[h];
                    k = l.allowedRules.generic;
                    h = l.disallowedRules.elements[h];
                    ...
                    if (a || k) {
                        v(b);
                        if (h)for (A = 0, n = h.length; A < n; ++A)if (!1 === c(h[A], b, m)) {
                            a = null;
                            break a
                        }
                        if (l)for (A = 0, n = l.length; A < n; ++A)c(l[A], b, m);
                        if (a)for (A = 0, n = a.length; A < n; ++A)e(a[A], b, m, u);
                        if (k)for (A =
                                       0, n = k.length; A < n; ++A)e(k[A], b, m, u);
                        a = m
                    } else a = null
                }
                ...
                var D = a.validStyles;
                k = a.validClasses;
                var h = b.attributes, w = b.styles, l = b.classes;
                u = b.classBackup;
                var H = b.styleBackup, I, y, q = [], m = [], z = /^data-cke-/;
                A = !1;
                delete h.style;
                delete h["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes)for (I in h)n[I] || (z.test(I) ? I == (y = I.replace(/^data-cke-saved-/, "")) || n[y] || (delete h[I], A = !0) : (delete h[I], A = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (I in w)a.allStyles ||
                    D[I] ? q.push(I + ":" + w[I]) : A = !0;
                    q.length && (h.style = q.sort().join("; "))
                } else H && (h.style = H);
                if (!a.allClasses || a.hadInvalidClass) {
                    for (I = 0; I < l.length; ++I)(a.allClasses || k[l[I]]) && m.push(l[I]);
                    m.length && (h["class"] = m.sort().join(" "));
                    u && m.length < u.split(/\s+/).length && (A = !0)
                } else u && (h["class"] = u);
                A && (g = 1);
        ...
        function u(a, b, c) {
            ...
            if (F.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(z()) : (a.parent && c.push({
                ...
                if (f) a.name = b, a.attributes = {}, c.push({check: "parent-down", el: a}); else {
                    f = a.parent;
                    for (var g = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == f.name, h, l, k = d.length; 0 < k;)e = d[--k], g && (e.type == CKEDITOR.NODE_TEXT || e.type == CKEDITOR.NODE_ELEMENT && F.$inline[e.name]) ? (h || (h = new CKEDITOR.htmlParser.element(b), h.insertAfter(a), c.push({
                            check: "parent-down",
                            el: h
                        })), h.add(e, 0)) : (h = null, l = F[f.name] || F.span, e.insertAfter(a), f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.type != CKEDITOR.NODE_ELEMENT ||
        ...
        function D(a, b) {
            var c = b.getDefinition(), d = c.attributes, f = c.styles, g, e, k, h;
            if (a.name != c.element)return !1;
            for (g in d)if ("class" == g)for (c = d[g].split(/\s+/), k = a.classes.join("|"); h = c.pop();) {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var f = this, g = [], e = this.editor && this.editor.config.protectedSource, k, h = !1, l = {
                    doFilter: !c,
                    doTransform: !0,
                    doCallbacks: !0,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))if (k = r(f, a, g, l), k & 1) h = !0; else if (k & 2)return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var u, m, t;
                            if (e)for (m = 0; m < e.length; ++m)if ((t = d.match(e[m])) && t[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (u = d.children[0]).type == CKEDITOR.NODE_ELEMENT && r(f, u, c, l);
                            c = !c.length
                        }
                        c || g.push(a)
                    }
                ...
                for (var t; c = g.pop();)c.type == CKEDITOR.NODE_ELEMENT ? u(c, d, a) : c.remove();
                for (; m = a.pop();)if (c = m.el, c.parent)switch (t = F[c.parent.name] || F.span, m.check) {
                    case "it":
                        F.$removeEmpty[c.name] && !c.children.length ? u(c, d, a) : p(c) || u(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type ==
                        CKEDITOR.NODE_DOCUMENT_FRAGMENT || t[c.name] || u(c, d, a);
                        break;
                    case "parent-down":
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (f = 0; f < a.length; ++f) {
                        b = a[f];
                        var g = void 0, e = void 0, k = void 0, h = void 0, l = void 0, u = void 0;
                        c = [];
                        for (e = 0; e < b.length; ++e)k = b[e], "string" == typeof k ? (k = k.split(/\s*:\s*/), h = k[0], l = null, u = k[1]) : (h = k.check, l = k.left, u = k.right), g || (g = k, g = g.element ? g.element : h ? h.match(/^([a-z0-9]+)/i)[0] :
                                g.left.getDefinition().element), l instanceof CKEDITOR.style && (l = B(l)), c.push({
                            check: h == g ? null : h,
                            left: l,
                ...
                var h = CKEDITOR.tools.clone(f), l = [], u;
                if (!1 !== b && (u = this._.transformations[f.name])) {
                    for (d =
                             0; d < u.length; ++d)x(this, f, u[d]);
                    t(f)
                }
                r(this, h, l, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
                b = 0 < l.length ? !1 : CKEDITOR.tools.objectCompare(f.attributes, h.attributes, !0) ? !0 : !1;
        ...
        var M = {styles: 1, attributes: 1, classes: 1}, I = {
                styles: "requiredStyles",
                attributes: "requiredAttributes",
                classes: "requiredClasses"
            }, H = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, R = {
                styles: /{([^}]+)}/,
                attrs: /\[([^\]]+)\]/,
                classes: /\(([^\)]+)\)/
            }, P = /^cke:(object|embed|param)$/,
            T = /^(object|embed|param)$/, O;
            ...
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles,
                        f = c.attributes, g, e, k, h;
                    a.name = c.element;
                    for (g in f)if ("class" == g)for (c = a.classes.join("|"), k = f[g].split(/\s+/); h = k.pop();)-1 == c.indexOf(h) && a.classes.push(h); else a.attributes[g] = f[g];
        ...
        add: function (a, e) {
            ...
            CKEDITOR.fire(a + CKEDITOR.tools.capitalize(this.fileName) +
                "Ready", b);
            return this.get(a)
        }, get: function (a) {
            ...
            CKEDITOR.scriptLoader.load(l, function (a, d) {
                ...
                for (var g = 0; g < a.length; g++)for (var k = m[a[g]], h = 0; h < k.length; h++) {
                    var l = k[h];
                    f[l] = this.get(l);
                    c[l] = 1
                }
        ...
        return function (b, c, d) {
            var l = {}, m = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], f;
                    for (f in a) {
                        var n = a[f], v = n && n.requires;
                        if (!e[f]) {
                            if (n.icons)for (var r = n.icons.split(","), q = r.length; q--;)CKEDITOR.skin.addIcon(r[q], n.path + "icons/" + (CKEDITOR.env.hidpi && n.hidpi ? "hidpi/" : "") + r[q] + ".png");
                            e[f] =
                                1
                        }
                    ...
                    if (b.length) m.call(this, b); else {
                        for (f in l)n = l[f], n.onLoad && !n.onLoad._called && (!1 === n.onLoad() && delete l[f], n.onLoad._called = 1);
                        c && c.call(d || window, l)
                    }
                }, this)
            };
        ...
        function n(a) {
            ...
            if (f)var e = new RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(e, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var k in c) {
                    var h = c[k], l = h.lang, u = null, m = h.requires, A;
                    CKEDITOR.tools.isArray(m) && (m = m.join(","));
                    if (m && (A = m.match(e)))for (; m = A.pop();)CKEDITOR.error("editor-plugin-required", {
                        plugin: m.replace(",", ""),
                        requiredBy: k
                    });
                    l && !a.lang[k] && (l.split && (l = l.split(",")), 0 <= CKEDITOR.tools.indexOf(l, a.langCode) ? u = a.langCode : (u = a.langCode.replace(/-.*/, ""), u = u != a.langCode && 0 <= CKEDITOR.tools.indexOf(l, u) ? u : 0 <= CKEDITOR.tools.indexOf(l, "en") ? "en" : l[0]), h.langEntries && h.langEntries[u] ? (a.lang[k] =
                            h.langEntries[u], u = null) : g.push(CKEDITOR.getUrl(h.path + "lang/" + u + ".js")));
                    f.push(u);
                    d.push(h)
                }
                CKEDITOR.scriptLoader.load(g, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], g = 0; g < c.length; g++)for (var e = 0; e < d.length; e++) {
                        var k = d[e];
                        0 === g && f[e] && k.lang && k.langEntries && (a.lang[k.name] = k.langEntries[f[e]]);
                        if (k[c[g]]) k[c[g]](a)
                    }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, f, g, e, k = 0; k < c.length; k++) {
                    var h = c[k], l = h.startContainer;
                    l.getName && "tr" == l.getName() ? (f || (f = l.getAscendant("table").clone(), f.append(l.getAscendant("tbody").clone()), d.append(f), f = f.findOne("tbody")), g && g.equals(l) || (g = l, e = l.clone(), f.append(e)), e.append(h.cloneContents())) : d.append(h.cloneContents())
                }
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (l, m, f) {
            function h(a) {
                ...
                if (0 < p.length)for (var c = 0; c < p.length; c++) {
                    var d = p[c], f = d.name, g = CKEDITOR.dtd[f], e = z.name && CKEDITOR.dtd[z.name];
            ...
            function n(b, c, d) {
                c = c || z || t;
                var e = z;
                void 0 === b.previous && (v(c, b) && (z = c, q.onTagOpen(f, {}), b.returnPoint = c = z), g(b), a(b) && !b.children.length || c.add(b), "pre" ==
                b.name && (u = !1), "textarea" == b.name && (A = !1));
            ...
            var q =
                new CKEDITOR.htmlParser, t = m instanceof CKEDITOR.htmlParser.element ? m : "string" == typeof m ? new CKEDITOR.htmlParser.element(m) : new CKEDITOR.htmlParser.fragment, p = [], w = [], z = t, A = "textarea" == t.name, u = "pre" == t.name;
            q.onTagOpen = function (d, f, g, l) {
            ...
            q.onTagClose = function (a) {
                ...
                for (var c = [], d = [], g = z; g != t && g.name != a;)g._.isBlockLike || d.unshift(g), c.push(g), g = g.returnPoint || g.parent;
                if (g != t) {
            ...
            q.onText = function (a) {
                ...
                if (!A && !g["#"] && b in e) q.onTagOpen(d[b] || ""), q.onText(a); else {
                    k();
                    h();
                    u || A || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                    a = new CKEDITOR.htmlParser.text(a);
                    if (v(z, a)) this.onTagOpen(f, {}, 0, 1);
                    z.add(a)
                }
            };
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, e = Array.prototype.slice.call(arguments, 1), m = this.rules, f = m.length, h, k, g, n;
        ...
        function a(a, f) {
            ...
            function e(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [], h = b(f), u, m;
                        if (h)for (k(h, 1) && e.push(h); h;)l(h) &&
                        (u = c(h)) && k(u) && ((m = c(u)) && !l(m) ? e.push(u) : (g(A).insertAfter(u), u.remove())), h = h.previous;
                        for (h = 0; h < e.length; h++)e[h].remove();
                        if (e = !a || !1 !== ("function" == typeof d ? d(f) : d)) A || CKEDITOR.env.needsBrFiller || f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? A || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (e = b(f), e = !e || "form" == f.name && "input" == e.name) : e = !1 : e = !1;
                        e && f.add(g(a))
                    }
                }
            }
            ...
            function k(a, b) {
                ...
                var c;
                return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(p)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && A && (!b || a.parent.name in n) || !A && ((c = a.previous) && "br" == c.name || !c || l(c))) ? !0 : !1
            }

            var h = {elements: {}}, A = "html" == f, n = CKEDITOR.tools.extend({}, u), x;
            for (x in n)"#" in z[x] || delete n[x];
            for (x in n)h.elements[x] = e(A, a.config.fillEmptyBlocks);
            h.root = e(A, !1);
            h.elements.br =
                function (a) {
                    return function (b) {
                        if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                            ...
                            if ("data-cke-bogus" in f || "data-cke-eol" in f) delete f["data-cke-bogus"]; else {
                                ...
                                var e = c(b);
                                !f && l(b.parent) ? m(b.parent, g(a)) : l(f) && e && !l(e) && g(a).insertBefore(f)
                            }
                        }
                    }
                }(A);
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, d, c = t(c, b), c = g(c, G), c = k(c), c = g(c, J), c = c.replace(I, "$1cke:$2"), c = c.replace(R, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"), c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), c = c.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + CKEDITOR.rnd + "-$2");
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var f = this.editor,
                    g, e, k, h;
                b && "object" == typeof b ? (g = b.context, c = b.fixForBody, d = b.dontFilter, e = b.filter, k = b.enterMode, h = b.protectedWhitespaces) : g = b;
        ...
        var p = /(?:&nbsp;|\xa0)$/, w = "{cke_protected}", z = CKEDITOR.dtd, A = "caption colgroup col thead tfoot tbody".split(" "), u = CKEDITOR.tools.extend({}, z.$blockLimit, z.$block), x = {
            elements: {
                input: f,
                textarea: f
            }
        }, D = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, y = {
            elements: {
                embed: function (a) {
                    var b = a.parent;
                    if (b && "object" == b.name) {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                for (; ;) {
                    m = e.name;
                    if (!(f =
                            a.onElementName(b, m)))return this.remove(), !1;
                    e.name = f;
                ...
                h = 0;
                for (k = m.length; h < k; h++)f = m[h], a.attribute(f[0], f[1]);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, e, m) {
            ...
            m.setSize("width", a, !0);
            k && (k.style.width = "1%");
            var g = (m.$.offsetHeight || 0) - (h.$.clientHeight ||
                0), f = Math.max(b - (e ? 0 : g), 0);
            b = e ? b + g : b;
            h.setStyle("height", f + "px");
            k && (k.style.width = "100%");
            this.fire("resize", {outerHeight: b, contentsHeight: f, outerWidth: a || m.getSize("width")})
        };
        ...
        function a(a) {
            ...
            m(b, d.block, f) && k.collapsed && !k.getCommonAncestor().isReadOnly() && (d = k.clone(), d.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(d), f.guard = function (a) {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                clearListeners: function () {
                    ...
                    CKEDITOR.NODE_ELEMENT && b.startContainer.is({
                        tr: 1,
                        table: 1,
                        tbody: 1,
                        thead: 1,
                    ...
                    var e, k;
                    if (g)for (; (e = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[e.getName()]) && (!k || !k[f]);)e.getName() in CKEDITOR.dtd.span ? b.splitElement(e) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(e), b.collapse(!0), e.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                    ...
                    function a() {
                        var b =
                            c.getDocument().$, d = b.getSelection(), f;
                    ...
                    function b() {
                        ...
                        "None" == d.type && f.equals(c) && (d = new CKEDITOR.dom.range(c),
                    ...
                    var c = z, d = {range: a, doc: a.document}, f = this.getHtmlFromRange(a);
                    ...
                    g.moveToPosition(d.bookmark.startNode,
                    ...
                    if (b) {
                        ...
                        if (d = a.checkStartOfBlock() &&
                                a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) {
                            a:{
                    ...
                    this.attachListener(a, "beforeGetData", function () {
                        var b = this.getData();
                        this.is("textarea") || !1 !==
                        a.config.ignoreEmptyParagraph && (b = b.replace(q, function (a, b) {
                            return b
                        }));
                        a.setData(b, null, 1)
                    }, this);
                    ...
                    if (CKEDITOR.env.edge && 14 < CKEDITOR.env.version) {
                        var d = function () {
                            var b = a.editable();
                            null != a._.previousScrollTop && b.getDocument().equals(CKEDITOR.document) &&
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (h) {
                            var e = f.getHead(), m = e.getCustomData("stylesheet");
                            m ? h != m.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? m.$.styleSheet.cssText = h : m.setText(h)) : (h = f.appendStyleText(h), h = new CKEDITOR.dom.element(h.ownerNode || h.owningElement), e.setCustomData("stylesheet", h), h.data("cke-temp", 1))
                        }
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in n) {
                                b = a.getSelection();
                                var f, e = b.getRanges()[0], h = e.startPath(), k, m, u, c = 8 == c;
                                CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (f = b.getSelectedElement()) || (f = l(b)) ? (a.fire("saveSnapshot"), e.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START),
                            ...
                            if (b in n) {
                                ...
                                if (d.collapsed)a:{
                                    ...
                                    if (f && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !c) && d.collapsed) {
                                        ...
                                        c.deleteContents(), d.getParent() && (d.moveChildren(e, !1), b.lastElement.mergeSiblings(), k(e, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b)return;
        ...
        t = function () {
            ...
            function b(c, d) {
                var f, g, e, h, k = [], m = d.range.startContainer;
                f = d.range.startPath();
                for (var m = l[m.getName()], n = 0, p = c.getChildren(), w = p.count(), x = -1, q = -1, t = 0, D = f.contains(l.$list); n < w; ++n)f = p.getItem(n), a(f) ? (e = f.getName(), D && e in CKEDITOR.dtd.$list ? k = k.concat(b(f, d)) : (h = !!m[e], "br" != e || !f.data("cke-eol") || n && n != w - 1 || (t = (g = n ? k[n - 1].node : p.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && l.$block[g.getName()]), -1 != x || h || (x = n), h || (q = n), k.push({
                            isElement: 1, isLineBreak: t, isBlock: f.isBlockBoundary(),
                            hasBlockSibling: g, node: f, name: e, allowed: h
                        }), g = t = 0)) : k.push({isElement: 0, node: f, allowed: 1});
                -1 < x && (k[x].firstNotAllowed = 1);
                -1 < q && (k[q].lastNotAllowed = 1);
                return k
            }

            function d(b, c) {
                var f = [], g = b.getChildren(), e = g.count(), k, h = 0, m = l[c], n = !b.is(l.$inline) || b.is("br");
                for (n && f.push(" "); h < e; h++)k = g.getItem(h), a(k) && !k.is(m) ? f = f.concat(d(k, c)) : f.push(k);
                n && f.push(" ");
                return f
            }
            ...
            function h(b, c, d, f) {
                ...
                (e = (new CKEDITOR.dom.walker(g)).next()) && a(e) && n[e.getName()] && (k = e.getPrevious()) && a(k) && !k.getParent().equals(b.startContainer) && d.contains(k) && f.contains(e) && e.isIdentical(k) && (e.moveChildren(k), e.remove(), h(b, c, d, f))
            }
            ...
            var l = CKEDITOR.dtd, n = {
                ...
                dl: 1,
                blockquote: 1
            }, w = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, p = CKEDITOR.tools.extend({}, l.$inline);
            delete p.br;
            return function (n, q, H, t) {
                var r = n.editor, z = !1;
                "unfiltered_html" == q && (q = "html", z = !0);
                if (!t.checkReadOnly()) {
                    ...
                    t = n.mergeCandidates;
                    var K, E;
                    "text" == n.type && q.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (K = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", q.document), q.insertNode(K), q.setStartAfter(K));
                    z = new CKEDITOR.dom.elementPath(q.startContainer);
                    n.endPath = v = new CKEDITOR.dom.elementPath(q.endContainer);
                    if (!q.collapsed) {
                        var r = v.block || v.blockLimit, W = q.getCommonAncestor();
                        r && !r.equals(W) && !r.contains(W) && q.checkEndOfBlock() &&
                        n.zombies.push(r);
                        q.deleteContents()
                    }
                    for (; (E = g(q)) && a(E) && E.isBlockBoundary() && z.contains(E);)q.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
                    h(q, n.blockLimit, z, v);
                    K && (q.setEndBefore(K), q.collapse(), K.remove());
                    K = q.startPath();
                    if (r = K.contains(e, !1, 1)) q.splitElement(r), n.inlineStylesRoot = r, n.inlineStylesPeak = K.lastElement;
                    K = q.createBookmark();
                    (r = K.startNode.getPrevious(c)) && a(r) && e(r) && t.push(r);
                    (r = K.startNode.getNext(c)) && a(r) && e(r) && t.push(r);
                    for (r = K.startNode; (r = r.getParent()) && e(r);)t.push(r);
                    q.moveToBookmark(K);
                    if (K = H) {
                        K = n.range;
                        ...
                        if ((U = K.startPath().block) && (1 != U.getChildCount() || !U.getBogus()))a:{
                            var L;
                            if (1 == E.getChildCount() && a(L = E.getFirst()) && L.is(w) && !L.hasAttribute("contenteditable")) {
                                U = L.getElementsByTag("*");
                                K = 0;
                                for (t = U.count(); K < t; K++)if (q = U.getItem(K), !q.is(p))break a;
                    ...
                    if (K) {
                        ...
                        var V, da;
                        q = L.startContainer;
                        var z = n.endPath.elements[0], Z, v = z.getPosition(q), W = !!z.getCommonAncestor(q) && v != CKEDITOR.POSITION_IDENTICAL && !(v & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        q = b(n.dataWrapper, n);
                        for (k(q, L); t < q.length; t++) {
                            v = q[t];
                            if (N = v.isLineBreak) {
                                N = L;
                                V = E;
                                var X = void 0, ga = void 0;
                                v.hasBlockSibling ? N = 1 : (X = N.startContainer.getAscendant(l.$block, 1)) && X.is({
                                        div: 1,
                                        p: 1
                                    }) ? (ga = X.getPosition(V), ga == CKEDITOR.POSITION_IDENTICAL ||
                                        ga == CKEDITOR.POSITION_CONTAINS ? N = 0 : (V = N.splitElement(X), N.moveToPosition(V, CKEDITOR.POSITION_AFTER_START), N = 1)) : N = 0
                            }
                            if (N) H = 0 < t; else {
                                N = L.startPath();
                                !v.isBlock && m(n.editor, N.block, N.blockLimit) && (Y = f(n.editor)) && (Y = K.createElement(Y), Y.appendBogus(), L.insertNode(Y), CKEDITOR.env.needsBrFiller && (S = Y.getBogus()) && S.remove(), L.moveToPosition(Y, CKEDITOR.POSITION_BEFORE_END));
                                ...
                                if (r && v.isElement) {
                                    N =
                                        L.startContainer;
                                    for (V = null; N && !l[N.getName()][v.name];) {
                                        if (N.equals(E)) {
                                            N = null;
                                            break
                                        }
                                ...
                                if (Z) {
                                    ...
                                    Z = 0
                                } else L.insertNode(v.node);
                                v.lastNotAllowed &&
                                t < q.length - 1 && ((da = W ? z : da) && L.setEndAt(da, CKEDITOR.POSITION_AFTER_START), r = 0);
                                L.collapse()
                            }
                        }
                        1 != q.length ? S = !1 : (S = q[0], S = S.isElement && "false" == S.node.getAttribute("contenteditable"));
                        S && (H = !0, N = q[0].node, L.setStartAt(N, CKEDITOR.POSITION_BEFORE_START), L.setEndAt(N, CKEDITOR.POSITION_AFTER_END));
                        n.dontMoveCaret = H;
                    ...
                    if (da)for (; Q =
                                      da.pop();)CKEDITOR.env.needsBrFiller ? Q.appendBogus() : Q.append(S.document.createText(" "));
        ...
        w = {
            eol: {
                detect: function (a, b) {
                    var c = a.range, d = c.clone(), f = c.clone(), g = new CKEDITOR.dom.elementPath(c.startContainer, b), e = new CKEDITOR.dom.elementPath(c.endContainer, b);
                    d.collapse(1);
                    f.collapse();
                ...
                shrink: function (a) {
                    a = a.range;
                    var b = a.startContainer, c = a.endContainer, d = a.startOffset, f = a.endOffset;
            ...
            return {
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), f = d.startPath(), g = d.endPath(), e = f.contains(CKEDITOR.dtd.$list), k = g.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            var d = a.mergeListBookmark.startNode, f = a.mergeListBookmark.endNode, g = new CKEDITOR.dom.elementPath(d, c), e = new CKEDITOR.dom.elementPath(f, c);
                            if (a.mergeList) {
                    ...
                    function a(c) {
                        ...
                        e.guard = function (a, e) {
                            ...
                            if (e && k && a.equals(k)) g = c.clone(), g.setEndAt(k, CKEDITOR.POSITION_BEFORE_END), f.push(g); else if (!e && h && a.equals(h)) g = c.clone(), g.setStartAt(h, CKEDITOR.POSITION_AFTER_START), f.push(g);
                            else {
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var e = c(g, f.bookmark), k = e.clone(), h, l, m = e.getCommonAncestor();
                            m.is(CKEDITOR.dtd.$tableContent) && !m.is(d) && (m = m.getAscendant("table",
                                !0));
                            l = m;
                            m = new CKEDITOR.dom.elementPath(e.startContainer, l);
                            l = new CKEDITOR.dom.elementPath(e.endContainer, l);
                            m = m.contains("table");
                            l = l.contains("table");
                            if (m || l) m && l && b(m, l) ? (f.tableSurroundingRange = k, k.setStartAt(m, CKEDITOR.POSITION_AFTER_END), k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), k = e.clone(), k.setEndAt(m, CKEDITOR.POSITION_AFTER_END), h = e.clone(), h.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), h = a(k).concat(a(h))) : m ? l || (f.tableSurroundingRange = k, k.setStartAt(m, CKEDITOR.POSITION_AFTER_END), e.setEndAt(m,
                    ...
                    var c = b.startPath(), d;
                    m(a, c.block, c.blockLimit) && (d = f(a)) && (d = b.document.createElement(d), d.appendBogus(),
        ...
        function b() {
            t = null;
            p && (CKEDITOR.tools.setTimeout(a, 0, this), p = !1)
        }
        ...
        function m(a, b) {
            ...
            if (c) {
                if (!1 !== b) {
                    var d = a.getDocument().getSelection().getNative(), g = d && "None" != d.type && d.getRangeAt(0), e = r.length;
                    if (c.getLength() > e && g && g.intersectsNode(c.$)) {
                        var k =
                            [{node: d.anchorNode, offset: d.anchorOffset}, {node: d.focusNode, offset: d.focusOffset}];
        ...
        function h(a, b) {
            var c =
                CKEDITOR.dom.element.createFromHtml('\x3cdiv data-cke-hidden-sel\x3d"1" data-cke-temp\x3d"1" style\x3d"' + (CKEDITOR.env.ie && 14 > CKEDITOR.env.version ? "display:none" : "position:fixed;top:0;left:-1000px") + '"\x3e' + (b || "\x26nbsp;") + "\x3c/div\x3e", a.document);
            a.fire("lockSnapshot");
            a.editable().append(c);
            var d = a.getSelection(1), f = a.createRange(), g = d.root.on("selectionchange", function (a) {
                a.cancel()
            }, null, null, 0);
        ...
        function g(a) {
            for (var b = 0; b < a.length; b++) {
                var c = a[b];
                c.getCommonAncestor().isReadOnly() &&
                a.splice(b, 1);
                if (!c.collapsed) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                ...
                var f = d.document, g = CKEDITOR.document, h = d.editable(), l = f.getBody(), u =
                    f.getDocumentElement(), q = h.isInline(), p, w;
                CKEDITOR.env.gecko && h.attachListener(h, "focus", function (a) {
                    a.removeListener();
                    0 !== p && (a = d.getSelection().getNative()) && a.isCollapsed && a.anchorNode == h.$ && (a = d.createRange(), a.moveToElementEditStart(h), a.select())
                }, null, null, -2);
                ...
                if (CKEDITOR.env.ie && !q) {
                    ...
                    h.attachListener(h, "mouseup", function (a) {
                        2 == a.data.$.button && t && (d.document.$.documentElement.scrollLeft = t.x, d.document.$.documentElement.scrollTop = t.y);
                        t = null
                    });
                            ...
                            u.on("mousedown", function (a) {
                                function b(a) {
                                    ...
                                    if (r) {
                                        ...
                                        r.setEndPoint(0 > z.compareEndPoints("StartToStart",
                                            c) ? "EndToEnd" : "StartToStart", c);
                                        r.select()
                                    }
                                }
                ...
                CKEDITOR.env.webkit &&
                h.attachListener(f, "keydown", function (a) {
        ...
        CKEDITOR.editor.prototype.unlockSelection = function (a) {
            ...
            return b ? (b.unlock(a), delete this._.savedSelection, !0) :
                !1
        };
            ...
            getNative: function () {
                return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = n ? this.document.$.selection : this.document.getWindow().$.getSelection()
                    ...
                    if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) {
                        ...
                        d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && A[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b =
                ...
                var a = n ? function () {
                        ...
                        var b = function (b, c) {
                            ...
                            for (var f = d.children, g, e, h = b.duplicate(), k = 0, l = f.length - 1, m = -1, n, q; k <= l;)if (m = Math.floor((k + l) / 2), g = f[m], h.moveToElementText(g), n = h.compareEndPoints("StartToStart", b), 0 < n) l = m - 1; else if (0 > n) k = m + 1; else return {
                                container: d,
                                offset: a(g)
                            };
                            if (-1 ==
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    if (e) this.fake(e); else {
                        if (n) {
                            ...
                            a = e.collapsed;
                            var q, p, w;
                            if ((c = e.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in A && (!c.is("a") || !c.getText()))try {
                            ...
                            b = w.startNode;
                            a || (g = w.endNode);
                            w = e.document.$.body.createTextRange();
                            w.moveToElementText(b.$);
                            w.moveStart("character", 1);
                            g ? (h = e.document.$.body.createTextRange(), h.moveToElementText(g.$), w.setEndPoint("EndToEnd", h), w.moveEnd("character", -1)) : (q = b.getNext(k), p = b.hasAscendant("pre"), q = !(q && q.getText && q.getText().match(h)) && (p || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), p = e.document.createElement("span"), p.setHtml("\x26#65279;"), p.insertBefore(b), q && e.document.createText("﻿").insertBefore(b));
                            e.setStartBefore(b);
                            b.remove();
                            a ? (q ? (w.moveStart("character", -1), w.select(), e.document.$.selection.clear()) : w.select(), e.moveToPosition(p, CKEDITOR.POSITION_BEFORE_START), p.remove()) : (e.setEndBefore(g), g.remove(), w.select())
                        } else {
                            g = this.getNative();
                            if (!g)return;
                            ...
                            for (w = 0; w < a.length; w++) {
                                if (w < a.length - 1 && (q = a[w], p = a[w + 1], h = q.clone(), h.setStart(q.endContainer, q.endOffset), h.setEnd(p.startContainer, p.startOffset), !h.collapsed && (h.shrink(CKEDITOR.NODE_ELEMENT, !0), e = h.getCommonAncestor(), h = h.getEnclosedNode(),
                                    ...
                                    p.setStart(q.startContainer, q.startOffset);
                                    a.splice(w--, 1);
                                    continue
                                }
                                e = a[w];
                                p = this.document.$.createRange();
                                e.collapsed && CKEDITOR.env.webkit && d(e) && (h = l(this.root), e.insertNode(h), (q = h.getNext()) && !h.getPrevious() && q.type == CKEDITOR.NODE_ELEMENT && "br" == q.getName() ? (m(this.root), e.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START)) : e.moveToPosition(h, CKEDITOR.POSITION_AFTER_END));
                ...
                this.reset();
                h(c, b);
                var d = this._.cache, f = new CKEDITOR.dom.range(this.root);
                f.setStartBefore(a);
                f.setEndAfter(a);
        ...
        function b(c) {
            ...
            if (c.collapsed) f = w(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var p = c.createBookmark(), t = p.startNode, r = p.endNode, z = t, u;
                if (!l) {
                ...
                for (z.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (z = 0); z;) {
                    l = !1;
                    if (z.equals(r)) z = null, l = !0; else {
                        var A = z.type == CKEDITOR.NODE_ELEMENT ? z.getName() : null, v = A && "false" == z.getAttribute("contentEditable"), x = A && z.getAttribute("data-nostyle");
                        ...
                        y = A ? !n[A] || x ? 0 : v && !m ? 0 : e(z, r, h, M) : 1;
                        if (y)if (B = z.getParent(), y = h, C = g, ea = k, !B || !(B.getDtd() || CKEDITOR.dtd.span)[C] && !ea || y.parentRule && !y.parentRule(B)) l = !0; else {
                            if (u || A && CKEDITOR.dtd.$removeEmpty[A] && (z.getPosition(r) | M) != M || (u = c.clone(), u.setStartBefore(z)), A = z.type, A == CKEDITOR.NODE_TEXT || v || A == CKEDITOR.NODE_ELEMENT && !z.getChildCount()) {
                                for (var A = z, E; (l = !A.getNext(J)) && (E = A.getParent(), n[E.getName()]) && e(E, t, h, I);)A = E;
                                u.setEndAfter(A)
                            }
                        } else l = !0;
                        z = z.getNextSourceNode(x || v)
                    }
                    if (l && u && !u.collapsed) {
                        for (var l = w(this, f), v = l.hasAttributes(), x = u.getCommonAncestor(), A = {}, y = {}, B = {}, C = {}, aa, fa, F; l && x;) {
                            if (x.getName() == g) {
                                for (aa in h.attributes)!C[aa] && (F = x.getAttribute(fa)) && (l.getAttribute(aa) == F ? y[aa] = 1 : C[aa] = 1);
                                for (fa in h.styles)!B[fa] && (F = x.getStyle(fa)) && (l.getStyle(fa) == F ? A[fa] = 1 : B[fa] = 1)
                            }
                            x = x.getParent()
                        }
                        for (aa in y)l.removeAttribute(aa);
                        for (fa in A)l.removeStyle(fa);
                        v && !l.hasAttributes() && (l = null);
                        l ? (u.extractContents().appendTo(l), u.insertNode(l),
                                q.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), u.extractContents().appendTo(l), u.insertNode(l), q.call(this, l), l.remove(!0));
                        u = null
                    }
                }
                c.moveToBookmark(p);
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                b();
                for (f = d; !f.equals(l);)g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ?
        ...
        function h(a) {
            ...
            for (var d, f; d = c.getNextParagraph();)this.checkElementRemovable(d) && (d.is("pre") ? ((f = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(f), k(d, f)) : r.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function r(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, f = u(this)[a.getName()], g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), e;
            for (e in d)if ("class" != e && !this._.definition.fullMatch || a.getAttribute(e) == x(e, d[e])) b &&
            "data-" == e.slice(0, 5) || (g = a.hasAttribute(e), a.removeAttribute(e));
            for (var h in c)this._.definition.fullMatch && a.getStyle(h) != x(h, c[h], !0) || (g = g || !!a.getStyle(h), a.removeStyle(h));
            t(a, f, B[a.getName()]);
        ...
        function q(a) {
            ...
            for (var g in b)if (g != this.element)for (c = a.getElementsByTag(g), f = c.count() - 1; 0 <= f; f--)d = c.getItem(f), d.isReadOnly() || t(d, b[g])
        }
        ...
        function D(a, b) {
            ...
            "string" == typeof b && (b =
                CKEDITOR.tools.parseCssText(b, !0));
        ...
        CKEDITOR.style = function (a, b) {
            ...
            this.type = a.type || (B[c] ? CKEDITOR.STYLE_BLOCK : C[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
        ...
        CKEDITOR.style.prototype = {
            apply: function (a) {
                ...
                this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type ==
                    CKEDITOR.STYLE_BLOCK ? f : this.type == CKEDITOR.STYLE_OBJECT ? l : null;
                ...
                switch (this.type) {
                    ...
                    case CKEDITOR.STYLE_INLINE:
                        for (var c =
                            a.elements, d = 0, f; d < c.length; d++)if (f = c[d], this.type != CKEDITOR.STYLE_INLINE || f != a.block && f != a.blockLimit) {
            ...
            checkElementMatch: function (a, b) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var h in c)if ("_length" != h)if (d = a.getAttribute(h) || "", "style" == h ? D(c[h], d) : c[h] == d) {
                            if (!b)return !0
                        } else if (b)return !1;
                        if (b)return !0
                    } else return !0
        ...
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            e.childNodes.length ==
            b && (a >= c ? (l = d.createText(""), l.insertAfter(this)) : (a = d.createText(""), a.insertAfter(l), a.remove()));
            return l
        ...
        function a(a, c, d) {
            ...
            m.equals(h.getPrevious()) ? (c.startOffset = c.startOffset - m.getLength() -
                    a.getPrevious().getLength(), m = a.getNext()) : m.equals(a.getPrevious()) && (c.startOffset -= m.getLength(), m = a.getNext());
        ...
        onLoad: function () {
            ...
            CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
                labeledElement: function (b, c, d, f) {
                    if (!(4 > arguments.length)) {
                        ...
                        c.includeLabel && (l["aria-labelledby"] = e.labelId);
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this,
                            b, c, d, function () {
                                for (var a = [], d = [], g = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio", l = 0; l < c.items.length; l++) {
                                    var w = c.items[l], z = void 0 !== w[2] ? w[2] : w[0], A = void 0 !== w[1] ? w[1] : w[0], u = CKEDITOR.tools.getNextId() + "_radio_input", x = u + "_label", u = CKEDITOR.tools.extend({}, c, {
                                        id: u,
                                        title: null,
                                        type: null
                                    }, !0), z = CKEDITOR.tools.extend({}, u, {title: z}, !0), D = {
                                        type: "radio",
                                    ...
                                    e._["default"] == A && (D.checked = "checked");
                                    m(u);
                                    m(z);
                                    "undefined" != typeof u.inputStyle &&
                                    (u.style = u.inputStyle);
                                    u.keyboardFocusable = !0;
                                    f.push(new CKEDITOR.ui.dialog.uiElement(b, u, y, "input", null, D));
                                    y.push(" ");
                                    new CKEDITOR.ui.dialog.uiElement(b, z, y, "label", null, {
                                        id: x,
                                        "for": D.id
                                    }, w[0]);
                                    a.push(y.join(""))
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                            ...
                            m(a);
                            for (var l = 0, w; l < c.items.length && (w = c.items[l]); l++)e.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== w[1] ? w[1] : w[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(w[0]));
                            "undefined" != typeof a.inputStyle && (a.style = a.inputStyle);
                    ...
                    if (!(3 > arguments.length)) {
                        a.call(this, c);
                        c.validate && (this.validate = c.validate);
                        var e = CKEDITOR.tools.extend({}, c), l = e.onClick;
                    ...
                    return function (d, f, e) {
                        if (!(3 > arguments.length)) {
                            ...
                            CKEDITOR.ui.dialog.uiElement.call(this, d, f, l, "span", null, null, "");
                            l = l.join("").match(a);
                            m = m.match(b) || ["", "", ""];
                            c.test(m[1]) && (m[1] = m[1].slice(0, -1), m[2] = "/" + m[2]);
                            e.push([m[1], " ", l[1] || "", m[2]].join(""))
                        }
                    }
            ...
            CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, c, {
                getInputElement: function () {
                    ...
                    var b = this._, c = CKEDITOR.document.getById(b.frameId).getFrameDocument(), d = b.definition, f = b.buttons, e = this.formLoadedNumber, l = this.formUnloadNumber, m = b.dialog._.editor.lang.dir, p = b.dialog._.editor.langCode;
            ...
            CKEDITOR.dialog.addUIElement("fieldset", {
                build: function (a, b, c) {
                    for (var d = b.children, f, e = [], l = [], m = 0; m < d.length && (f = d[m]); m++) {
                        var p = [];
                        e.push(p);
                        l.push(CKEDITOR.dialog._.uiElementBuilders[f.type].build(a, f, p))
                    }
        ...
        function k(a) {
            function b(c) {
                var k = a.getSize(), l = CKEDITOR.document.getWindow().getViewPaneSize(), m = c.data.$.screenX, n = c.data.$.screenY, w = m - d.x, p = n - d.y;
                d = {x: m, y: n};
                f.x += w;
                f.y += p;
            ...
            var d = null, f = null, e = a.getParentEditor(), g = e.config.dialog_magnetDistance, h = CKEDITOR.skin.margins || [0, 0, 0, 0];
        ...
        function g(a) {
            function b(c) {
                var n = "rtl" == e.lang.dir, w = m.width, p = m.height, q = w + (c.data.$.screenX - l.x) * (n ? -1 : 1) * (a._.moved ? 1 : 2), z = p + (c.data.$.screenY - l.y) * (a._.moved ? 1 : 2), u = a._.element.getFirst(), u = n && u.getComputedStyle("right"), t = a.getPosition();
                t.y + z > k.height && (z = k.height - t.y);
                (n ? u : t.x) + q > k.width && (q = k.width - (n ? u : t.x));
                if (f == CKEDITOR.DIALOG_RESIZE_WIDTH || f == CKEDITOR.DIALOG_RESIZE_BOTH) w = Math.max(d.minWidth ||
                    0, q - g);
                if (f == CKEDITOR.DIALOG_RESIZE_HEIGHT || f == CKEDITOR.DIALOG_RESIZE_BOTH) p = Math.max(d.minHeight || 0, z - h);
                a.resize(w, p);
                a._.moved || a.layout();
                c.data.preventDefault()
            }
            ...
            if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
                ...
                a.on("load", function () {
                    ...
                    b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + e.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(e.lang.common.resize) +
                        '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + w + ', event )"\x3e' + ("ltr" == e.lang.dir ? "◢" : "◣") + "\x3c/div\x3e");
        ...
        function v(a) {
            var b = CKEDITOR.document.getWindow(), c = a.config, d = c.dialog_backgroundCoverColor || "white", f = c.dialog_backgroundCoverOpacity, e = c.baseFloatZIndex, c = CKEDITOR.tools.genKey(d, f, e), g = D[c];
            g ? g.show() : (e = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ?
                    "absolute" : "fixed", "; z-index: ", e, "; top: 0px; left: 0px; ", CKEDITOR.env.ie6Compat ? "" : "background-color: " + d, '" class\x3d"cke_dialog_background_cover"\x3e'], CKEDITOR.env.ie6Compat && (d = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" + d + ";\\'\x3e\x3c/body\x3e\x3c/html\x3e", e.push('\x3ciframe hidefocus\x3d"true" frameborder\x3d"0" id\x3d"cke_dialog_background_iframe" src\x3d"javascript:'), e.push("void((function(){" + encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.write( '" +
                        d + "' );document.close();") + "})())"), e.push('" style\x3d"position:absolute;left:0;top:0;width:100%;height: 100%;filter: progid:DXImageTransform.Microsoft.Alpha(opacity\x3d0)"\x3e\x3c/iframe\x3e')), e.push("\x3c/div\x3e"), g = CKEDITOR.dom.element.createFromHtml(e.join("")), g.setOpacity(void 0 !== f ? f : .5), g.on("keydown", n), g.on("keypress", n), g.on("keyup", n), g.appendTo(CKEDITOR.document.getBody()), D[c] = g);
        ...
        function r(a) {
            y && (a.focusManager.remove(y),
                a = CKEDITOR.document.getWindow(), y.hide(), a.removeListener("resize", x), CKEDITOR.env.ie6Compat && a.$.setTimeout(function () {
        ...
        CKEDITOR.dialog = function (b, f) {
            ...
            function n(c) {
                if (y == CKEDITOR.dialog._.currentTop) {
                    ...
                    x = v = 0;
                    if (9 == d || d == CKEDITOR.SHIFT + 9) m(d == CKEDITOR.SHIFT + 9 ? -1 : 1), x = 1; else if (d == CKEDITOR.ALT + 121 && !y._.tabBarMode && 1 < y.getPageCount()) y._.tabBarMode = !0, y._.tabs[y._.currentTabId][0].focus(), y._.currentFocusIndex = -1, x = 1; else if (-1 != CKEDITOR.tools.indexOf(g,
                        ...
                        this._.tabBarMode = !1, this._.currentFocusIndex = -1, m(1), x = 1;
                    w(c)
                }
            }
            ...
            var q = CKEDITOR.dialog._.dialogDefinitions[f], z = CKEDITOR.tools.clone(p), t = b.config.dialog_buttonsOrder || "OS", r = b.lang.dir, A = {}, x, v;
            ("OS" == t && CKEDITOR.env.mac || "rtl" == t && "ltr" == r || "ltr" == t && "rtl" == r) && z.buttons.reverse();
            ...
            if (b._.removeDialogTabs && (A = b._.removeDialogTabs[f]))for (r = 0; r < A.length; r++)q.removeContents(A[r]);
            ...
            this.on("show", function () {
                ...
                b.config.dialog_startupFocusTab && a ? (y._.tabBarMode = !0, y._.tabs[y._.currentTabId][0].focus(), y._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, q.onFocus ?
            ...
            for (r = 0; r < q.contents.length; r++)(A = q.contents[r]) && this.addPage(A);
            ...
            for (r = 0; r < A.length; r++)this._.buttons[A[r].id] = A[r]
        };
        ...
        var x, D = {}, y, B = {}, C = function (a) {
            ...
            (b = B[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + f]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key),
                a.data.preventDefault()))
                ...
                uiElement: function (a, b, c, d, f, e, g) {
                    if (!(4 > arguments.length)) {
                        var h = (d.call ? d(b) : d) || "div",
                            k = ["\x3c", h, " "], l = (f && f.call ? f(b) : f) || {}, m = (e && e.call ? e(b) : e) || {}, n = (g && g.call ? g.call(this, a, b) : g) || "", w = this.domId = m.id || CKEDITOR.tools.getNextId() + "_uiElement";
                        ...
                        for (var q = m["class"] && m["class"].split ? m["class"].split(" ") : [], w = 0; w < q.length; w++)q[w] && (p[q[w]] = 1);
                        q = [];
                        for (w in p)q.push(w);
                        m["class"] = q.join(" ");
                        b.title && (m.title = b.title);
                        p = (b.style || "").split(";");
                        b.align && (q = b.align, l["margin-left"] = "left" == q ? 0 : "auto", l["margin-right"] = "right" == q ? 0 : "auto");
                        for (w in l)p.push(w + ":" + l[w]);
                        b.hidden && p.push("display:none");
                        for (w = p.length - 1; 0 <= w; w--)"" === p[w] && p.splice(w, 1);
                        0 < p.length && (m.style = (m.style ? m.style + "; " : "") + p.join("; "));
                        for (w in m)k.push(w + '\x3d"' + CKEDITOR.tools.htmlEncode(m[w]) + '" ');
                    ...
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var e = this._.children = b, g = f && f.widths || null, h = f && f.height || null, k, l = {role: "presentation"};
                        f && f.align && (l.align = f.align);
                        CKEDITOR.ui.dialog.uiElement.call(this, a, f || {type: "hbox"}, d, "table", {}, l, function () {
            ...
            exec: function (a) {
                ...
                if (d) {
                    ...
                    if (b == CKEDITOR.TRISTATE_OFF) {
                        ...
                        b = [];
                        m = [];
                        for (h = {}; 0 < f.length;)k = f.shift(), d = k.getParent(), k.getPrevious() ? k.getNext() ? (k.breakParent(k.getParent()), m.push(k.getNext())) : k.remove().insertAfter(d) : k.remove().insertBefore(d), d.getCustomData("blockquote_processed") || (m.push(d), CKEDITOR.dom.element.setMarker(h, d, "blockquote_processed", !0)), b.push(k);
                        CKEDITOR.dom.element.clearAllMarkers(h);
        ...
        function e(b) {
            ...
            function m(a, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    ...
                    var w = 0, d = d.getWindow();
                    CKEDITOR.env.webkit ? (f.append(n), n.addClass("cke_editable"), f.is("body") || (w = "static" != f.getComputedStyle("position") ?
                            f : CKEDITOR.dom.element.get(f.$.offsetParent), w = w.getDocumentPosition().y)) : f.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(n);
                    n.setStyles({
                        position: "absolute",
                    ...
                    (w = n.getParent().isReadOnly()) ? (n.setOpacity(0), n.setAttribute("contenteditable", !0)) : n.setStyle("ltr" == b.config.contentsLangDirection ?
                            "left" : "right", "-10000px");
            ...
            b.getClipboardData = function (a, c) {
                ...
                !1 === A() && (b.removeListener("paste", d), h && b.fire("pasteDialog", e) ? (b.on("pasteDialogCommit", f), b.on("dialogHide", function (a) {
                        a.removeListener();
        ...
        function h(b) {
            ...
            b.on("contentDom", function () {
                ...
                var k = b.editable(), l = CKEDITOR.plugins.clipboard.getDropTarget(b), m = b.ui.space("top"), A = b.ui.space("bottom");
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "dialog", init: function (a) {
                ...
                a.on("paste", function (d) {
                        d = d.data;
                        var f = d.type, e = d.dataValue, h, m = a.config.clipboard_defaultContentType ||
                            "html", n = d.dataTransfer.getTransferType(a);
                        h = "html" == f || "html" == d.preSniffing ? "html" : b(e);
                        "htmlifiedtext" == h && (e = c(a.config, e));
                        "text" == f && "html" == h ? e = l(a, e, k.get("plain-text")) : n == CKEDITOR.DATA_TRANSFER_EXTERNAL && a.pasteFilter && !d.dontFilter && (e = l(a, e, a.pasteFilter));
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            internalDrop: function (b, c, d, f) {
                var e = CKEDITOR.plugins.clipboard, h = f.editable(), k, l;
                f.fire("saveSnapshot");
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (k) {
                                ...
                                var D = b.document.getById(x);
                                h.moveToPosition(D, CKEDITOR.POSITION_BEFORE_START);
                                D.remove()
                            } else {
                                var y = b.document.$.elementFromPoint(d, f), B = new CKEDITOR.dom.element(y), C;
                                if (B.equals(b.editable()) || "html" == B.getName())return e && e.startContainer && !e.startContainer.equals(b.editable()) ? e : null;
                                C = B.getClientRect();
                                d < C.left ? h.setStartAt(B, CKEDITOR.POSITION_AFTER_START) : h.setStartAt(B, CKEDITOR.POSITION_BEFORE_END);
                                h.collapse(!0)
                            }
                        } catch (F) {
                            return null
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function (a) {
                ...
                "text/html" == a ? (b = b.replace(this._.metaRegExp, ""), (a = this._.bodyRegExp.exec(b)) &&
                    a.length && (b = a[1], b = b.replace(this._.fragmentRegExp, ""))) : "Text" == a && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == b.substring(0, 7) && (b = "");
                return b
            }, setData: function (a, b) {
                a = this._.normalizeType(a);
                this._.data[a] = b;
        ...
        var a = CKEDITOR.addTemplate("panel", '\x3cdiv lang\x3d"{langCode}" id\x3d"{id}" dir\x3d{dir} class\x3d"cke cke_reset_all {editorId} cke_panel cke_panel {cls} cke_{dir}" style\x3d"z-index:{z-index}" role\x3d"presentation"\x3e{frame}\x3c/div\x3e'), e = CKEDITOR.addTemplate("panel-frame",
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (b, c, d, e) {
                ...
                addBlock: function (a, c) {
                    ...
                    var n = this.element, g = this._.iframe, g = CKEDITOR.env.ie && !CKEDITOR.env.edge ? g : new CKEDITOR.dom.window(g.$.contentWindow), v = n.getDocument(), r = this._.parentElement.getPositionedAncestor(),
                        q = c.getDocumentPosition(v), v = r ? r.getDocumentPosition(v) : {
                                x: 0,
                                y: 0
                            }, t = "rtl" == this._.dir, p = q.x + (e || 0) - v.x, w = q.y + (m || 0) - v.y;
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            t ? e < c && (p = g > c ? p + c : b.width > c ? p - a.left : p - a.right + b.width) :
                                e < c && (p = g > c ? p - c : b.width > c ? p - a.right + b.width : p - a.left);
                            c = a.top;
            ...
            $: function (a, b) {
                ...
                add: function (a) {
                    ...
                    if (!g) {
                        ...
                        v["rtl" == k.lang.dir ? 37 : 39] = CKEDITOR.env.ie ? "mouseup" : "click";
                    ...
                    a(h);
                    for (var v = k.elementPath(), v = ['\x3cdiv class\x3d"cke_menu' + (v && v.direction() != k.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], r = h.length, q = r && h[0].group, t = 0; t < r; t++) {
                        var p = h[t];
                        q != p.group && (v.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'),
                            q = p.group);
                        p.render(this, t, v)
                    }
                    v.push("\x3c/div\x3e");
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, b, c) {
                ...
                render: function (a, e, m) {
                    ...
                    var n = this.getItems, v = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";", r = this.name;
                    this.icon && !/\./.test(this.icon) && (r =
                        this.icon);
                    a = {
                        id: f,
                        name: this.name,
        ...
        function a(a, b) {
            function m(b) {
                ...
                b.equals(a.editable()) || "true" == b.getAttribute("contenteditable") ?
                    (c = a.createRange(), c.selectNodeContents(b), c = c.select()) : (c = a.getSelection(), c.selectElement(b));
            ...
            b.html += '\x3cspan id\x3d"' + h + '_label" class\x3d"cke_voice_label"\x3e' + a.lang.elementspath.eleLabel + '\x3c/span\x3e\x3cspan id\x3d"' + h + '" class\x3d"cke_path" role\x3d"group" aria-labelledby\x3d"' +
                h + '_label"\x3e\x3cspan class\x3d"cke_path_empty"\x3e\x26nbsp;\x3c/span\x3e\x3c/span\x3e';
            a.on("uiReady", function () {
                var b = a.ui.space("path");
                b && a.focusManager.add(b, 1)
            });
            g.onClick = m;
            var v = CKEDITOR.tools.addFunction(m), r = CKEDITOR.tools.addFunction(function (b, c) {
                var f = g.idBase, e;
                ...
                switch (c.getKeystroke()) {
                    ...
                    case CKEDITOR.SHIFT + 9:
                        return (e =
                            CKEDITOR.document.getById(f + (b - 1))) || (e = CKEDITOR.document.getById(f + (g.list.length - 1))), e.focus(), !1;
                    case 27:
                        return a.focus(), !1;
                    case 13:
                    case 32:
            ...
            a.on("selectionChange", function () {
                for (var b = [], f = g.list = [], e = [], m = g.filters, l = !0, A = a.elementPath().elements, u, x = A.length; x--;) {
                    var D = A[x], y = 0;
                    u = D.data("cke-display-name") ? D.data("cke-display-name") : D.data("cke-real-element-type") ? D.data("cke-real-element-type") : D.getName();
                    (l = D.hasAttribute("contenteditable") ? "true" == D.getAttribute("contenteditable") :
                        l) || D.hasAttribute("contenteditable") || (y = 1);
        ...
        var c = CKEDITOR.addTemplate("pathItem",
        ...
        CKEDITOR.plugins.add("indent",
            {
                init: function (b) {
                    ...
                    b.on("dirChanged", function (a) {
                        ...
                        d.setStartBefore(f);
                        d.setEndAfter(f);
                        for (var e = new CKEDITOR.dom.walker(d),
                                 k; k = e.next();)if (k.type == CKEDITOR.NODE_ELEMENT)if (!k.equals(f) && k.getDirection()) d.setStartAfter(k), e = new CKEDITOR.dom.walker(d); else {
        ...
        function a(a) {
            function c(e) {
                ...
                if (!h || !l)return !1;
                for (var q = h, h = [], t = !1; !t;)q.equals(l) && (t = !0), h.push(q), q = q.getNext();
                ...
                for (var q = d.isIndent ? 1 : -1, l = h[0], h = h[h.length - 1], t = CKEDITOR.plugins.list.listToArray(e, g), x = t[h.getCustomData("listarray_index")].indent, l = l.getCustomData("listarray_index"); l <= h.getCustomData("listarray_index"); l++)if (t[l].indent += q, 0 < q) {
                    var v = t[l].parent;
                    t[l].parent = new CKEDITOR.dom.element(v.getName(), v.getDocument())
                }
                for (l = h.getCustomData("listarray_index") + 1; l < t.length && t[l].indent > x; l++)t[l].indent += q;
                h = CKEDITOR.plugins.list.arrayToList(t, g, null, a.config.enterMode, e.getDirection());
                if (!d.isIndent) {
                    var y;
                    if ((y = e.getParent()) && y.is("li"))for (var q = h.listNode.getChildren(), B = [], C, l = q.count() - 1; 0 <= l; l--)(C = q.getItem(l)) && C.is && C.is("li") && B.push(C)
                }
                h && h.listNode.replace(e);
                if (B && B.length)for (l = 0; l < B.length; l++) {
                    for (C = e = B[l]; (C = C.getNext()) && C.is && C.getName() in m;)CKEDITOR.env.needsNbspFiller && !e.getFirst(b) && e.append(r.document.createText(" ")), e.append(C);
                    e.insertAfter(y)
                }
            ...
            for (var d = this, g = this.database, m = this.context, l = a.getSelection(), l = (l && l.getRanges()).createIterator(), r; r = l.getNextRange();) {
                ...
                if (!q) {
                    ...
                    t && t.type == CKEDITOR.NODE_ELEMENT && t.getName() in m && (r.setStartAt(t, CKEDITOR.POSITION_AFTER_START), r.setEndAt(t, CKEDITOR.POSITION_BEFORE_END),
                        q = t)
                }
                q && r.startContainer.type == CKEDITOR.NODE_ELEMENT && r.startContainer.getName() in m && (t = new CKEDITOR.dom.walker(r), t.evaluator = e, r.startContainer = t.next());
                q && r.endContainer.type == CKEDITOR.NODE_ELEMENT && r.endContainer.getName() in m && (t = new CKEDITOR.dom.walker(r), t.evaluator = e, r.endContainer = t.previous());
                if (q)return c(q)
            }
            return 0
        }
        ...
        var c = CKEDITOR.dom.walker.whitespaces(!0), d = CKEDITOR.dom.walker.bookmark(!1,
            !0), l = CKEDITOR.TRISTATE_DISABLED, m = CKEDITOR.TRISTATE_OFF;
                ...
                function c(b) {
                    ...
                    this.jobs[this.isIndent ?
                        ...
                        refresh: this.isIndent ? function (a, b) {
                                var c = this.getContext(b), d = CKEDITOR.plugins.indentList.firstItemInPath(this.context, b, c);
        ...
        function a(a, b, c) {
            ...
            var k = CKEDITOR.plugins.list.arrayToList(f, c, null, a.config.enterMode, b.root.getAttribute("dir")).listNode, l, m;
            d(!0);
            d();
            k.replace(b.root);
        ...
        function l(a, d, f) {
            ...
            d.trim(!1, !0);
            var h = d.createBookmark(), k = new CKEDITOR.dom.elementPath(d.startContainer), l = k.block, k = k.lastElement.getAscendant("li", 1) || l, r = new CKEDITOR.dom.elementPath(f.startContainer), v = r.contains(CKEDITOR.dtd.$listItem),
                r = r.contains(CKEDITOR.dtd.$list);
            l ? (l = l.getBogus()) && l.remove() : r && (l = r.getPrevious(g)) && n(l) && l.remove();
            ...
            for (; f.checkStartOfBlock() && f.checkEndOfBlock();) {
                ...
                e = r.block;
                if (!e)break;
                e.is("li") && (k = e.getParent(), e.equals(k.getLast(g)) && e.equals(k.getFirst(g)) &&
                (e = k));
        ...
        CKEDITOR.plugins.list = {
            listToArray: function (a, b, c, d, e) {
                ...
                for (var h, l = a[c].parent.getDocument(), m = new CKEDITOR.dom.documentFragment(l), n = null, r = c, v = Math.max(a[c].indent, 0), C =
                    ...
                    if (G.indent == v) {
                        ...
                        C = n.append(G.element.clone(0, 1));
                        F != n.getDirection(1) && C.setAttribute("dir", F);
                        for (h = 0; h < G.contents.length; h++)C.append(G.contents[h].clone(1, 1));
                        r++
                    } else if (G.indent == Math.max(v, 0) + 1) G = a[r - 1].element.getDirection(1), r = CKEDITOR.plugins.list.arrayToList(a, null, r, d, G != F ? F : null), !C.getChildCount() &&
                    CKEDITOR.env.needsNbspFiller && 7 >= l.$.documentMode && C.append(l.createText(" ")), C.append(r.listNode), r = r.nextIndex; else if (-1 == G.indent && !c && h) {
                        f[h.getName()] ? (C = G.element.clone(!1, !0), F != h.getDirection(1) && C.setAttribute("dir", F)) : C = new CKEDITOR.dom.documentFragment(l);
                        var n = h.getDirection(1) != F, M = G.element, I = M.getAttribute("class"), H = M.getAttribute("style"), R = C.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (d != CKEDITOR.ENTER_BR || n || H || I), P, T = G.contents.length, O;
                        for (h = 0; h < T; h++)if (P = G.contents[h], k(P) &&
                            1 < T) R ? O = P.clone(1, 1) : C.append(P.clone(1, 1)); else if (P.type == CKEDITOR.NODE_ELEMENT && P.isBlockBoundary()) {
                        ...
                        } else R ? (E || (E = l.createElement(J), C.append(E), n && E.setAttribute("dir", F)), H && E.setAttribute("style", H), I && E.setAttribute("class", I), O && (E.append(O), O = null), E.append(P.clone(1,
                                1))) : C.append(P.clone(1, 1));
                        O && ((E || C).append(O), O = null);
                        C.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && r != a.length - 1 && (CKEDITOR.env.needsBrFiller && (F = C.getLast()) && F.type == CKEDITOR.NODE_ELEMENT && F.is("br") && F.remove(), (F = C.getLast(g)) && F.type == CKEDITOR.NODE_ELEMENT && F.is(CKEDITOR.dtd.$block) || C.append(l.createElement("br")));
                    ...
                    E = null;
                    if (a.length <= r || Math.max(a[r].indent, 0) < v)break
                }
                if (b)for (a = m.getFirst(); a;) {
                    if (a.type ==
                        CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(b, a), a.getName() in CKEDITOR.dtd.$listItem && (c = a, l = e = d = void 0, d = c.getDirection()))) {
        ...
        var v = /^h[1-6]$/, r = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT);
        e.prototype = {
            exec: function (b) {
                ...
                for (var d = e.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0; (l = h.getNextRange()) && ++n;) {
                    var r = l.getBoundaryNodes(), y = r.startNode, B = r.endNode;
                    y.type == CKEDITOR.NODE_ELEMENT && "td" == y.getName() && l.setStartAt(r.startNode, CKEDITOR.POSITION_AFTER_START);
                    ...
                    for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; r = l.getNextParagraph();)if (!r.getCustomData("list_block")) {
                        ...
                        for (var C = b.elementPath(r), y = C.elements, B = 0, C = C.blockLimit, F, E = y.length - 1; 0 <= E && (F = y[E]); E--)if (f[F.getName()] && C.contains(F)) {
                            C.removeCustomData("list_group_object_" + n);
                            (y = F.getCustomData("list_group_object")) ? y.contents.push(r) :
                                (y = {
                                    root: F,
                                    contents: [r]
                                }, k.push(y), CKEDITOR.dom.element.setMarker(m, F, "list_group_object", y));
                            B = 1;
                            break
                        }
                        B || (B = C, B.getCustomData("list_group_object_" + n) ? B.getCustomData("list_group_object_" + n).contents.push(r) : (y = {
                                root: B,
                                contents: [r]
                ...
                for (F = []; 0 < k.length;)if (y = k.shift(), this.state == CKEDITOR.TRISTATE_OFF)if (f[y.root.getName()]) {
                    ...
                    C = [];
                    for (r = 0; r < n.contents.length; r++)E =
                        n.contents[r], (E = E.getAscendant("li", !0)) && !E.getCustomData("list_item_processed") && (C.push(E), CKEDITOR.dom.element.setMarker(y, E, "list_item_processed", !0));
                    for (var E = n.root.getDocument(), J = void 0, G = void 0, r = 0; r < C.length; r++) {
                        var M = C[r].getCustomData("listarray_index"), J = B[M].parent;
                        J.is(this.type) || (G = E.createElement(this.type), J.copyAttributes(G, {
                            start: 1,
                            type: 1
                        }), G.removeStyle("list-style-type"), B[M].parent = G)
                    }
                    y = CKEDITOR.plugins.list.arrayToList(B, y, null, h.config.enterMode);
                    B = void 0;
                    C = y.listNode.getChildCount();
                    for (r = 0; r < C && (B = y.listNode.getChild(r)); r++)B.getName() == this.type && l.push(B);
                    ...
                    n = [];
                    1 == C.length && C[0].equals(l.root) && (y = h.createElement("div"), C[0].moveChildren && C[0].moveChildren(y), C[0].append(y), C[0] = y);
                    l = l.contents[0].getParent();
                    for (E = 0; E < C.length; E++)l = l.getCommonAncestor(C[E].getParent());
                    J = B.config.useComputedState;
                    B = y = void 0;
                    J = void 0 === J || J;
                    for (E = 0; E < C.length; E++)for (G = C[E]; M = G.getParent();) {
                        if (M.equals(l)) {
                            n.push(G);
                            !B && G.getDirection() && (B = 1);
                            G = G.getDirection(J);
                            null !== y && (y = y && y != G ? null : G);
                            break
                        }
                        G = M
                    }
                    if (!(1 > n.length)) {
                        ...
                        r.push(E);
                        for (J = r = void 0; n.length;)r = n.shift(), J = h.createElement("li"), G = r, G.is("pre") || v.test(G.getName()) || "false" == G.getAttribute("contenteditable") ? r.appendTo(J) : (r.copyAttributes(J), y && r.getDirection() && (J.removeStyle("direction"), J.removeAttribute("dir")), r.moveChildren(J), r.remove()), J.appendTo(E);
                        y && B && E.setAttribute("dir", y);
                        C ? E.insertBefore(C) :
                            E.appendTo(l)
                    }
            ...
            requires: "indentlist", init: function (a) {
                a.blockless || (a.addCommand("numberedlist",
                    ...
                    if ("wysiwyg" == a.mode && c in {8: 1, 46: 1}) {
                        ...
                        if (h && h.collapsed) {
                            var r =
                                8 == c, v = a.editable(), D = new CKEDITOR.dom.walker(h.clone());
                            ...
                            if (r) {
                                var y;
                                (y = k.contains(f)) && h.checkBoundaryOfElement(y, CKEDITOR.START) && (y = y.getParent()) && y.is("li") && (y = m(y)) ? (e = y, y = y.getPrevious(g), c.moveToPosition(y && n(y) ? y : e, CKEDITOR.POSITION_BEFORE_START)) : (D.range.setStartAt(v, CKEDITOR.POSITION_AFTER_START), D.range.setEnd(h.startContainer, h.startOffset), (y = D.previous()) &&
                                    y.type == CKEDITOR.NODE_ELEMENT && (y.getName() in f || y.is("li")) && (y.is("li") || (D.range.selectNodeContents(y), D.reset(), D.evaluator = d, y = D.previous()), e = y, c.moveToElementEditEnd(e), c.moveToPosition(c.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
                                if (e) l(a, c, h), b.cancel(); else {
                                    var B = k.contains(f);
                                    B && h.checkBoundaryOfElement(B, CKEDITOR.START) && (e = B.getFirst(g), h.checkBoundaryOfElement(e, CKEDITOR.START) && (y = B.getPrevious(g), m(e) ? y && (h.moveToElementEditEnd(y), h.select()) : a.execCommand("outdent"), b.cancel()))
                                }
                            } else if (e =
                                    k.contains("li")) {
                                if (D.range.setEndAt(v, CKEDITOR.POSITION_BEFORE_END), r = (v = e.getLast(g)) && d(v) ? v : e, k = 0, (y = D.next()) && y.type == CKEDITOR.NODE_ELEMENT && y.getName() in f && y.equals(v) ? (k = 1, y = D.next()) : h.checkBoundaryOfElement(r, CKEDITOR.END) && (k = 2), k && y) {
                                    ...
                                    2 == k && (c.moveToPosition(c.endPath().block,
        ...
        function () {
            ...
            CKEDITOR.plugins.enterkey = {
                enterBlock: function (a,
                    ...
                    if (l = l || e(a)) {
                        l = b(l);
                        var r = l.document, q = l.checkStartOfBlock(), t = l.checkEndOfBlock(), p = a.elementPath(l.startContainer), w = p.block, z = f == CKEDITOR.ENTER_DIV ? "div" : "p", A;
                        if (q && t) {
                            if (w && (w.is("li") || w.getParent().is("li"))) {
                                ...
                                A = l.getParent();
                                v = !w.hasPrevious();
                                var u = !w.hasNext(), z = a.getSelection(), x = z.createBookmarks(), q = w.getDirection(1), t = w.getAttribute("class"), D = w.getAttribute("style"), y = A.getDirection(1) != q;
                                a = a.enterMode != CKEDITOR.ENTER_BR || y || D || t;
                        ...
                        if (q = l.splitBlock(z)) {
                            ...
                            p = q.wasStartOfBlock;
                            a = q.wasEndOfBlock;
                            w ? (x = w.getParent(), x.is("li") && (w.breakParent(x),
                                    w.move(w.getNext(), 1))) : f && (x = f.getParent()) && x.is("li") && (f.breakParent(x), x = f.getNext(), l.moveToElementEditStart(x), f.move(f.getPrevious()));
                            if (p || a) {
                                if (f) {
                                    if (f.is("li") || !h.test(f.getName()) && !f.is("pre")) A = f.clone()
                                } else w && (A = w.clone());
                                A ? v && !A.is("li") && A.renameNode(z) : x && x.is("li") ? A = x : (A = r.createElement(z), f && (u = f.getDirection()) && A.setAttribute("dir", u));
                                if (r = q.elementPath)for (v = 0, z = r.elements.length; v < z; v++) {
                                    x = r.elements[v];
                                    if (x.equals(r.block) || x.equals(r.blockLimit))break;
                                    CKEDITOR.dtd.$removeEmpty[x.getName()] &&
                                    (x = x.clone(), A.moveChildren(x), A.append(x))
                                }
                                A.appendBogus();
                                A.getParent() || l.insertNode(A);
                                A.is("li") && A.removeAttribute("value");
                                !CKEDITOR.env.ie || !p || a && f.getChildCount() || (l.moveToElementEditStart(a ? f : A), l.select());
                                l.moveToElementEditStart(p && !a ? w : A)
                            ...
                            x.type == CKEDITOR.NODE_ELEMENT && x.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? r.createElement("br") : r.createText(" ")).insertBefore(x)), w && l.moveToElementEditStart(w);
                            l.select();
                            l.scrollIntoView()
                        }
                    }
                    ...
                    if (c = c || e(a)) {
                        var l = c.document, m = c.checkEndOfBlock(), t = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()), p = t.block, w = p && t.block.getName();
                        d || "li" != w ? (!d && m && h.test(w) ? (m = p.getDirection()) ? (l = l.createElement("div"), l.setAttribute("dir", m), l.insertAfter(p), c.setStart(l,
        ...
        function a(a, b) {
            var c = {}, d = [], l = {nbsp: " ", shy: "­", gt: "\x3e", lt: "\x3c", amp: "\x26", apos: "'", quot: '"'};
        ...
        function l(a, f, g, m) {
            if (m && m.length)for (var v, r = m.length; r--;)if (v = m[r], "hbox" != v.type && "vbox" != v.type && "fieldset" != v.type || l(a, f, g, v.children), v.filebrowser)if ("string" == typeof v.filebrowser && (v.filebrowser = {
        ...
        function f(a, b) {
            ...
            if ("function" != typeof b || !1 !== b.call(this._.filebrowserSe))if (!f || !1 !== f.call(this._.filebrowserSe, a, b))if ("string" == typeof b && b && alert(b), a && (d = this._.filebrowserSe, c = d.getDialog(), d = d.filebrowser.target || null))if (d = d.split(":"), f = c.getContentElement(d[0], d[1])) f.setValue(a), c.selectPage(d[0])
        }
        ...
        function a(a) {
            var d = a.config, l = a.fire("uiSpace", {space: "top", html: ""}).html, m = function () {
                ...
                function g(a) {
                    var b =
                        k.getDocumentPosition();
                    switch (a) {
                        case "top":
                            f("absolute", "top", b.y - z - x);
                            break;
                        case "pin":
                            f("fixed", "top", y);
                            break;
                        case "bottom":
                            f("absolute", "top", b.y + (p.height || p.bottom - p.top) + x)
                    }
                    l = a
                }

                var l, k, t, p, w, z, A, u = d.floatSpaceDockedOffsetX || 0, x = d.floatSpaceDockedOffsetY || 0, D = d.floatSpacePinnedOffsetX || 0, y = d.floatSpacePinnedOffsetY || 0;
                return function (f) {
                    if (k = a.editable()) {
        ...
        var a = '\x3ca id\x3d"{id}" class\x3d"cke_button cke_button__{name} cke_button_{state} {cls}"' +
            (CKEDITOR.env.gecko && !CKEDITOR.env.hc ? "" : " href\x3d\"javascript:void('{titleJs}')\"") + ' title\x3d"{title}" tabindex\x3d"-1" hidefocus\x3d"true" role\x3d"button" aria-labelledby\x3d"{id}_label" aria-haspopup\x3d"{hasArrow}" aria-disabled\x3d"{ariaDisabled}"';
        ...
        var a = a + (' onkeydown\x3d"return CKEDITOR.tools.callFunction({keydownFn},event);" onfocus\x3d"return CKEDITOR.tools.callFunction({focusFn},event);" ' +
            (CKEDITOR.env.ie ? 'onclick\x3d"return false;" onmouseup' : "onclick") + '\x3d"CKEDITOR.tools.callFunction({clickFn},this);return false;"\x3e\x3cspan class\x3d"cke_button_icon cke_button__{iconName}_icon" style\x3d"{style}"'), a = a + '\x3e\x26nbsp;\x3c/span\x3e\x3cspan id\x3d"{id}_label" class\x3d"cke_button_label cke_button__{name}_label" aria-hidden\x3d"false"\x3e{label}\x3c/span\x3e{arrowHtml}\x3c/a\x3e', e = CKEDITOR.addTemplate("buttonArrow", '\x3cspan class\x3d"cke_button_arrow"\x3e' + (CKEDITOR.env.hc ? "\x26#9660;" :
                "") + "\x3c/span\x3e"), b = CKEDITOR.addTemplate("button", a);
        ...
        CKEDITOR.editor.prototype.createFakeParserElement =
            function (a, c, d, h) {
                ...
                CKEDITOR.env.hc || (c.src = CKEDITOR.tools.transparentImageData);
                d && (c["data-cke-real-element-type"] = d);
                h && (c["data-cke-resizable"] = h, h = a.attributes, a = new e, d = h.width, h = h.height, void 0 !== d && (a.rules.width = b(d)), void 0 !== h && (a.rules.height =
                    b(h)), a.populate(c));
        ...
        function b(b, c) {
            var d = b.plugins.link, f = d.compiledProtectionFunction.params, e, h;
        ...
        CKEDITOR.plugins.add("link", {
            requires: "dialog,fakeobjects", onLoad: function () {
                ...
                CKEDITOR.dialog.isTabEnabled(a, "link", "target") && (b = b.replace("]",
                    ",target,onclick]"));
                ...
                a.on("doubleclick", function (b) {
                    ...
                    c.isReadOnly() || (c.is("a") ? (b.data.dialog = !c.getAttribute("name") || c.getAttribute("href") && c.getChildCount() ? "link" : "anchor", b.data.link =
        ...
        var d = /^javascript:/, l = /^mailto:([^?]+)(?:\?(.+))?$/, m = /subject=([^;?:@&=$,\/]*)/i, f = /body=([^;?:@&=$,\/]*)/i, h = /^#(.*)$/, k = /^((?:http|https|ftp|news):\/\/)?(.*)$/, g = /^(_(?:self|top|parent|blank))$/,
            n = /^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/, v = /^javascript:([^(]+)\(([^)]+)\)$/, r = /\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/, q = /(?:^|,)([^=]+)=(\d+|yes|no)/gi, t = {
                id: "advId",
                dir: "advLangDir",
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (a) {
                ...
                var c = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "", e = a.plugins.link.compiledProtectionFunction,
                    u = a.config.emailProtection, x, D = {};
                ...
                if (!D.type)if (u = c.match(h)) D.type =
                    "anchor", D.anchor = {}, D.anchor.name = D.anchor.id = u[1]; else if (u = c.match(l)) {
                    x = c.match(m);
                    c = c.match(f);
                    D.type = "email";
                    var y = D.email = {};
                    y.address = u[1];
                    x && (y.subject = decodeURIComponent(x[1]));
                    c && (y.body = decodeURIComponent(c[1]))
                } else c && (x = c.match(k)) && (D.type = "url", D.url = {}, D.url.protocol = x[1], D.url.url = x[2]);
                if (b) {
                    if (c = b.getAttribute("target")) D.target = {
                        type: c.match(g) ? c : "frame",
                        name: c
                    }; else if (c = (c = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && c.match(r))for (D.target = {
                        type: "popup",
                        name: c[1]
                    }; u =
                                                                                                                       q.exec(c[2]);)"yes" != u[2] && "1" != u[2] || u[1] in {
                        height: 1,
                        width: 1,
                        top: 1,
                        left: 1
                    } ? isFinite(u[2]) && (D.target[u[1]] = u[2]) : D.target[u[1]] = !0;
                    var c = {}, B;
                    for (B in t)(u = b.getAttribute(B)) && (c[t[B]] = u);
                    if (B = b.data("cke-saved-name") || c.advName) c.advName = B;
                    CKEDITOR.tools.isEmpty(c) || (D.advanced = c)
                }
                return D
            }, getLinkAttributes: function (c, d) {
                var f = c.config.emailProtection || "", h = {};
                switch (d.type) {
                    case "url":
                        var f = d.url && void 0 !== d.url.protocol ? d.url.protocol : "http://", g = d.url && CKEDITOR.tools.trim(d.url.url) || "";
        ...
        function f(a) {
            var b =
                a.doc, c = F('\x3cspan contenteditable\x3d"false" style\x3d"' + Q + "position:absolute;border-top:1px dashed " + a.boxColor + '"\x3e\x3c/span\x3e', b), d = CKEDITOR.getUrl(this.path + "images/" + (E.hidpi ? "hidpi/" : "") + "icon" + (a.rtl ? "-rtl" : "") + ".png");
            B(c, {
                attach: function () {
                ...
                lineChildren: [B(F('\x3cspan title\x3d"' + a.editor.lang.magicline.title + '" contenteditable\x3d"false"\x3e\x26#8629;\x3c/span\x3e', b), {
                    base: Q + "height:17px;width:17px;" + (a.rtl ? "left" :
                        "right") + ":17px;background:url(" + d + ") center no-repeat " + a.boxColor + ";cursor:pointer;" + (E.hc ? "font-size: 15px;line-height:14px;border:1px solid #fff;text-align:center;" : "") + (E.hidpi ? "background-size: 9px 10px;" : ""),
                ...
                place: function () {
                    ...
                    f && e ? k.top = f.size.margin.bottom === e.size.margin.top ? 0 | f.size.bottom + f.size.margin.bottom / 2 : f.size.margin.bottom < e.size.margin.top ? f.size.bottom + f.size.margin.bottom :
                                f.size.bottom + f.size.margin.bottom - e.size.margin.top : f ? e || (k.top = f.size.bottom + f.size.margin.bottom) : k.top = e.size.top - e.size.margin.top;
                    d.is(T) || l(k.top, b.scroll.y - 15, b.scroll.y + 5) ? (k.top = a.inInlineMode ? 0 : b.scroll.y, this.look(T)) : d.is(O) || l(k.top, b.pane.bottom - 5, b.pane.bottom + 15) ? (k.top = a.inInlineMode ? b.editable.height + b.editable.padding.top + b.editable.padding.bottom : b.pane.bottom - 1, this.look(O)) : (a.inInlineMode && (k.top -= b.editable.top + b.editable.border.top), this.look(K));
                    a.inInlineMode && (k.top--,
                        k.top += b.editable.scroll.top, k.left += b.editable.scroll.left);
        ...
        function h(a, b, c) {
            ...
            E.ie && a.enterMode == CKEDITOR.ENTER_BR ? e = a.doc.createText(ca) : (e = (e = m(a.element, !0)) && e.data("cke-enter-mode") || a.enterMode, e = new C(M[e], a.doc), e.is("br") || a.doc.createText(ca).appendTo(e));
        ...
        function k(a, c) {
            return {
                canUndo: !0, modes: {wysiwyg: 1}, exec: function () {
                    function f(b) {
                        var d = E.ie && 9 > E.version ? " " : ca, e = a.hotNode && a.hotNode.getText() == d && a.element.equals(a.hotNode) && a.lastCmdDirection === !!c;
                        h(a, function (d) {
                    ...
                    return function (e) {
                        ...
                        var h;
                        e = e.getAscendant(N, 1);
                        if (!t(a, e) && e && !e.equals(a.editable) && !e.contains(a.editable)) {
                            (h = m(e)) && "false" == h.getAttribute("contenteditable") && (e = h);
                            a.element = e;
                            h = d(a, e, !c);
                            var g;
                            n(h) && h.is(a.triggers) && h.is(L) && (!d(a, h, !c) || (g = d(a, h, !c)) && n(g) && g.is(a.triggers)) ? f(h) : (g = b(a, e), n(g) && (d(a, g, !c) ? (e = d(a, g, !c)) && n(e) && e.is(a.triggers) && f(g) :
                                    f(g)))
                        }
                    }
                }()
        ...
        function w(a) {
            ...
            u(a, b);
            return !h && 0 <= b.size.top && l(c.y, 0, b.size.top + f) ? (a = a.inInlineMode || 0 === d.scroll.y ? T : K, new e([null, b, I, P, a])) : h && b.size.bottom <= d.pane.height && l(c.y, b.size.bottom - f, d.pane.height) ? (a = a.inInlineMode || l(b.size.bottom, d.pane.height - f, d.pane.height) ? O : K, new e([b, null, H, P, a])) : null
        }

        function z(a) {
            var c = a.mouse, f = a.view, h = a.triggerOffset, g = b(a);
            if (!g)return null;
            u(a, g);
            var h = Math.min(h, 0 | g.size.outerHeight / 2), k = [], m, r;
            if (l(c.y, g.size.top - 1, g.size.top + h)) r = !1; else if (l(c.y, g.size.bottom - h, g.size.bottom + 1)) r = !0; else return null;
            if (v(g) || p(a, g, r) || g.getParent().is(W))return null;
            var t = d(a, g, !r);
            if (t) {
                if (t && t.type == CKEDITOR.NODE_TEXT)return null;
                if (n(t)) {
                    if (v(t) || !q(a, t) || t.getParent().is(W))return null;
                    k = [t, g][r ? "reverse" : "concat"]().concat([R, P])
                }
            } else g.equals(a.editable[r ? "getLast" : "getFirst"](a.isRelevant)) ? (x(a), r && l(c.y, g.size.bottom - h, f.pane.height) &&
                l(g.size.bottom, f.pane.height - h, f.pane.height) ? m = O : l(c.y, 0, g.size.top + h) && (m = T)) : m = K, k = [null, g][r ? "reverse" : "concat"]().concat([r ? H : I, P, m, g.equals(a.editable[r ? "getLast" : "getFirst"](a.isRelevant)) ? r ? O : T : K]);
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function (a) {
                ...
                a.on("contentDom", function () {
                    ...
                    l.is(G.$inline) || (m.inInlineMode && !r(l) && l.setStyles({
                        position: "relative",
                        top: null,
                        left: null
                    }), f.call(this, m), D(m), l.attachListener(a, "beforeUndoImage", function () {
                        m.line.detach()
                        ...
                        if ("wysiwyg" == a.mode)if (m.inInlineMode) {
                            ...
                            var d = m.view.editable,
                                f = m.view.scroll;
                            c > d.left - f.x && c < d.right - f.x && b > d.top - f.y && b < d.bottom - f.y || (clearTimeout(u), u = null, m.line.detach())
                        ...
                        if ("wysiwyg" == a.mode && !a.readOnly && !u) {
                            ...
                            u = setTimeout(function () {
                                ...
                                u = m.trigger = null;
                                D(m);
                                p && !m.hiddenMode && a.focusManager.hasFocus && !m.line.mouseNear() && (m.element = da(m, !0)) && ((m.trigger = w(m) || z(m) || ga(m)) && !t(m, m.trigger.upper || m.trigger.lower) ? m.line.attach().place() : (m.trigger = null, m.line.detach()), p = !1)
                            }, 30)
                        }
                        ...
                        for (f in{
                            ...
                            br: 1,
                            div: 1
                        })for (b = a.document.getElementsByTag(f), d = b.count(); d--;)if ((c = b.getItem(d)).data("cke-magicline-hot")) {
                            m.hotNode =
                                c;
        ...
        var B = CKEDITOR.tools.extend, C = CKEDITOR.dom.element, F = C.createFromHtml, E = CKEDITOR.env, J = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, G = CKEDITOR.dtd, M = {}, I = 128, H = 64, R = 32, P = 16, T = 4, O = 2, K = 1, ca = " ", W = G.$listItem, U = G.$tableContent, L = B({}, G.$nonEditable, G.$empty),
            N = G.$block, S = 100, Q = "width:0px;height:0px;padding:0px;margin:0px;display:block;z-index:9999;color:#fff;position:absolute;font-size: 0px;line-height:0px;", Y = Q + "border-color:transparent;display:block;border-style:solid;", V = "\x3cspan\x3e" + ca + "\x3c/span\x3e";
        ...
        var da = function () {
            ...
            function b(f) {
                ...
                for (var e = Number.MAX_VALUE, m, q, r, t; g && !g.equals(h) && (q = h.getNext(f.isRelevant));)m =
                    Math.abs(c(f, h, q) - f.mouse.y), m < e && (e = m, r = h, t = q), h = q, u(f, h);
                if (!r || !t || !l(f.mouse.y, r.size.top, t.size.bottom))return null;
                k.upper = r;
                k.lower = t;
                return k.set(R, 8)
            }
        ...
        function e(a, b) {
            if (a && a.type == CKEDITOR.NODE_ELEMENT && "form" == a.getName() && 0 <
                b.length)for (var c = b.length - 1; 0 <= c; c--) {
                var d = b[c][0], e = b[c][1];
        ...
        CKEDITOR.plugins.add("maximize", {
            init: function (a) {
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    var f = a.lang, h = CKEDITOR.document, k = h.getWindow(), g, n, v, r = CKEDITOR.TRISTATE_OFF;
                        ...
                        readOnly: 1, editorFocus: !1, exec: function () {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                for (p = a.container; p = p.getParent();)p.setCustomData("maximize_saved_styles",
                                    b(p)), p.setStyle("z-index", a.config.baseFloatZIndex - 5);
                                ...
                                q.setStyle("position", CKEDITOR.env.gecko &&
                                ...
                                for (var p = [t, q], z = 0; z < p.length; z++)c(p[z], p[z].getCustomData("maximize_saved_styles")), p[z].removeCustomData("maximize_saved_styles");
                                for (p = a.container; p = p.getParent();)c(p,
                                    p.getCustomData("maximize_saved_styles")), p.removeCustomData("maximize_saved_styles");
                                CKEDITOR.env.ie ? setTimeout(function () {
                                        k.$.scrollTo(v.x, v.y)
                            ...
                            this.toggleState();
                            if (p = this.uiItems[0]) t = this.state == CKEDITOR.TRISTATE_OFF ?
                                f.maximize.maximize : f.maximize.minimize, p = CKEDITOR.document.getById(p._.id), p.getChild(1).setHtml(t), p.setAttribute("title", t), p.setAttribute("href", 'javascript:void("' + t + '");');
                ...
                b.on("paste", function (e) {
                    ...
                    if (f && (c || /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(f))) {
                        ...
                        var h = a(b, d, function () {
                            if (h) b.fire("paste", m); else if (!b.config.pasteFromWordPromptCleanup || c || confirm(b.lang.pastefromword.confirmCleanup)) m.dataValue = CKEDITOR.cleanWord(f, b);
                            c = 0
                        });
                        h && e.cancel()
                    }
    ...
    }),CKEDITOR.plugins.removeformat =
        {
            commands: {
                removeformat: {
                    exec: function (a) {
                        for (var e = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter, d = a.getSelection().getRanges(), l = d.createIterator(), m = function (a) {
                            return a.type == CKEDITOR.NODE_ELEMENT
                        }, f; f = l.getNextRange();) {
                            f.collapsed || f.enlarge(CKEDITOR.ENLARGE_ELEMENT);
                            var h = f.createBookmark(),
                                k = h.startNode, g = h.endNode, n = function (b) {
                                    for (var d = a.elementPath(b), f = d.elements, h = 1, g; (g = f[h]) && !g.equals(d.block) && !g.equals(d.blockLimit); h++)e.test(g.getName()) && c(a, g) && b.breakParent(g)
                                };
                            n(k);
                            if (g)for (n(g), k = k.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); k && !k.equals(g);)if (k.isReadOnly()) {
                                ...
                                k = k.getNext(m)
                            } else n = k.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), "img" == k.getName() && k.data("cke-realelement") || !c(a, k) || (e.test(k.getName()) ? k.remove(1) :
        ...
        init: function (a) {
            ...
            var c = a.config, d = a.ui.spaceId("resizer"), l = a.element ? a.element.getDirection(1) : "ltr";
            ...
            if (!1 !== c.resize_enabled) {
                ...
                a.on("uiSpace", function (b) {
                    if ("bottom" == b.data.space) {
                        ...
                        var f = '\x3cspan id\x3d"' + d + '" class\x3d"cke_resizer' + c + " cke_resizer_" + l + '" title\x3d"' + CKEDITOR.tools.htmlEncode(a.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event)"\x3e' + ("ltr" ==
                            l ? "◢" : "◣") + "\x3c/span\x3e";
                        "ltr" == l && "ltr" == c ? b.data.html += f : b.data.html = f + b.data.html
                    }
                }, a, null, 100);
        ...
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
                ...
                CKEDITOR.UI_MENUBUTTON, {
                    ...
                    onMenu: function () {
                        ...
                        a.getMenuItem("scaytToggle").label =
                            a.lang.scayt[c && b.state.scayt[a.name] ? "btn_disable" : "btn_enable"];
                        c = {
            ...
            a.on("beforeCommandExec", function (b) {
                var c = a.scayt, d = null, g = !1, m = !0;
                b.data.name in e.options.disablingCommandExec && "wysiwyg" == a.mode ? c && (e.destroy(a), a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED)) :
            ...
            a.on("readOnly", function (b) {
                var c;
                b && (c = a.scayt, !0 === b.editor.readOnly ? c && c.fire("removeMarkupInDocument", {}) : c ? c.fire("startSpellCheck, startGrammarCheck") :
            ...
            a.on("reloadMarkupScayt", function (b) {
                ...
                setTimeout(function () {
                    ...
                    d && d.ltr && d.rtl && (a.document.fire("keydown", new CKEDITOR.dom.event({keyCode: 37})), b.removeMarkupInSelectionNode(c),
            ...
            if (a.config.scayt_disableOptionsStorage) {
                ...
                a.config.scayt_disableOptionsStorage = function (a) {
                    for (var b = [], c = 0; c < a.length; c++) {
                        var e = a[c], v = !!m(a, "options");
                        if (!m(d, e) || v && m(l, function (a) {
                                if ("lang" === a)return !1
                            }))return;
        ...
        createScayt: function (a) {
            ...
            this.loadScaytLibrary(a, function (a) {
                ...
                d ? (d = {
                    ...
                    }), a.scayt = d, a.fire("scaytButtonState", a.readOnly ? CKEDITOR.TRISTATE_DISABLED :
        ...
        loadScaytLibrary: function (a, e) {
            var b = this, c, d;
            this.loadingHelper[a.name] || ("undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? (this.loadingHelper[a.name] = e, this.loadingHelper.loadOrder.push(a.name), c = new Date, c = c.getTime(), d = a.config.scayt_srcUrl, d += 0 <= d.indexOf("?") ? "" : "?" + c, this.loadingHelper.ckscaytLoading || (CKEDITOR.scriptLoader.load(d,
                    function (a) {
                        if (a) {
        ...
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            var a = CKEDITOR.plugins.undo.Image.prototype, e = "function" == typeof a.equalsContent ? "equalsContent" : "equals";
        ...
        function e(b, c) {
            for (var d = a(b), f = d[0], e = f.getAscendant("table"), f = f.getDocument(), g = d[0].getParent(), h = g.$.rowIndex, d = d[d.length - 1], k = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = new CKEDITOR.dom.element(e.$.rows[k]), h = c ? h : k, g = c ? g : d, d = CKEDITOR.tools.buildTableMap(e), e = d[h], h = c ? d[h - 1] : d[h + 1], d = d[0].length, f = f.createElement("tr"), k = 0; e[k] && k < d; k++) {
                var m;
                1 < e[k].rowSpan && h && e[k] == h[k] ? (m = e[k], m.rowSpan += 1) : (m = (new CKEDITOR.dom.element(e[k])).clone(), m.removeAttribute("rowSpan"), m.appendBogus(), f.append(m), m = m.$);
                k += m.colSpan - 1
            }
            ...
            if (c instanceof CKEDITOR.dom.selection) {
                ...
                for (var d = d[d.length - 1], g = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], h = c; h <= g; h++) {
                    for (var k = e[h], m = new CKEDITOR.dom.element(f.$.rows[h]),
                             l = 0; l < k.length; l++) {
                        var n = new CKEDITOR.dom.element(k[l]), v = n.getParent().$.rowIndex;
                        1 == n.$.rowSpan ? n.remove() : (--n.$.rowSpan, v == h && (v = e[h + 1], v[l - 1] ? n.insertAfter(new CKEDITOR.dom.element(v[l - 1])) : (new CKEDITOR.dom.element(f.$.rows[h + 1])).append(n, 1)));
                        l += n.$.colSpan - 1
                    }
                    d.push(m)
                }
        ...
        function d(b, d) {
            for (var f = a(b), e = f[0].getAscendant("table"), g = c(f, 1), f = c(f), g = d ? g : f, h = CKEDITOR.tools.buildTableMap(e), e = [], f = [], k = h.length, m = 0; m < k; m++)e.push(h[m][g]), f.push(d ? h[m][g - 1] : h[m][g + 1]);
            for (m = 0; m < k; m++)e[m] && (1 < e[m].colSpan && f[m] == e[m] ? (g = e[m], g.colSpan += 1) : (g = (new CKEDITOR.dom.element(e[m])).clone(),
        ...
        function k(b, c, d) {
            ...
            var k = CKEDITOR.tools.buildTableMap(e), m = k.length, l = k[0].length, n = b.getParent().$.rowIndex, v = h(k, n, b);
            if (c) {
                var B;
                try {
                    var C = parseInt(b.getAttribute("rowspan"), 10) || 1;
                    g = parseInt(b.getAttribute("colspan"), 10) || 1;
                    B = k["up" == c ? n - C : "down" == c ? n + C : n]["left" == c ? v - g : "right" == c ? v + g : v]
                } catch (F) {
                    return !1
                }
                if (!B || b.$ == B)return !1;
            ...
            c = b.getDocument();
            var E = n,
                C = B = 0, J = !d && new CKEDITOR.dom.documentFragment(c), G = 0;
            for (c = 0; c < f.length; c++) {
                g = f[c];
                var M = g.getParent(), I = g.getFirst(), H = g.$.colSpan, R = g.$.rowSpan, M = M.$.rowIndex, P = h(k, M, g), G = G + H * R, C = Math.max(C, P - v + H);
                B = Math.max(B, M - n + R);
                d || (H = g, (R = H.getBogus()) && R.remove(), H.trim(), g.getChildren().count() && (M == E || !I || I.isBlockBoundary && I.isBlockBoundary({br: 1}) || (E = J.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !E || E.is && E.is("br") || J.append("br")), g.moveChildren(J)), c ? g.remove() : g.setHtml(""));
                E = M
            }
            if (d)return B *
                C == G;
            J.moveChildren(b);
            b.appendBogus();
            C >= l ? b.removeAttribute("rowSpan") : b.$.rowSpan = B;
            B >= m ? b.removeAttribute("colSpan") : b.$.colSpan = C;
        ...
        function g(b, c) {
            ...
            if (c)return !0;
            var d = d[0], f = d.getParent(), e = f.getAscendant("table"), g = CKEDITOR.tools.buildTableMap(e), k = f.$.rowIndex, m = h(g, k, d), l = d.$.rowSpan, n;
            if (1 < l) {
                n = Math.ceil(l / 2);
                for (var l = Math.floor(l /
                    2), f = k + n, e = new CKEDITOR.dom.element(e.$.rows[f]), g = h(g, f), v, f = d.clone(), k = 0; k < g.length; k++)if (v = g[k], v.parentNode == e.$ && k > m) {
                    f.insertBefore(new CKEDITOR.dom.element(v));
                    break
                } else v = null;
                v || e.append(f)
            } else for (l = n = 1, e = f.clone(), e.insertAfter(f), e.append(f = d.clone()), v = h(g, k), m = 0; m < v.length; m++)v[m].rowSpan++;
            f.appendBogus();
            d.$.rowSpan = n;
            f.$.rowSpan = l;
            1 == n && d.removeAttribute("rowSpan");
            1 == l && f.removeAttribute("rowSpan");
            return f
        }
        ...
        function n(b, c) {
            ...
            if (1 < k) f = Math.ceil(k / 2), k = Math.floor(k / 2); else {
                ...
                for (e = 0; e < m.length; e++)m[e].colSpan++
            }
            e = d.clone();
            e.insertAfter(d);
            e.appendBogus();
        ...
        CKEDITOR.plugins.tabletools =
            {
                ...
                t("columnDelete", h({
                    requiredContent: "table", exec: function (b) {
                        ...
                        for (var e = CKEDITOR.tools.buildTableMap(b), g, h, k = [], m = 0, l = e.length; m < l; m++)for (var n = 0, q = e[m].length; n < q; n++)e[m][n] == c.$ && (g = n), e[m][n] == d.$ && (h = n);
                        for (m = g; m <= h; m++)for (n = 0; n < e.length; n++)d = e[n], c = new CKEDITOR.dom.element(b.$.rows[n]), d = new CKEDITOR.dom.element(d[m]), d.$ && (1 == d.$.colSpan ? d.remove() : --d.$.colSpan, n += d.$.rowSpan - 1, c.$.cells.length || k.push(c));
            ...
            function b() {
                for (var g = c(), h = CKEDITOR.tools.clone(a.config.toolbarGroups) ||
                    ...
                    if ("/" != l) {
                        ...
                        var t, p = l.groups;
                        if (p)for (var w = 0; w < p.length; w++)t = p[w], (t = g[t]) && f(l, t);
                        (t = g[l.name]) && f(l, t)
                    }
                }
                return h
        ...
        CKEDITOR.plugins.add("toolbar", {
            requires: "button", init: function (d) {
                var e,
                    m = function (a, b) {
                        var c, g = "rtl" == d.lang.dir, n = d.config.toolbarGroupCycling, v = g ? 37 : 39, g = g ? 39 : 37, n = void 0 === n || n;
                        switch (b) {
                            case 9:
                            case CKEDITOR.SHIFT + 9:
                ...
                d.on("uiSpace", function (c) {
                    if (c.data.space == d.config.toolbarLocation) {
                        c.removeListener();
                        d.toolbox = new b;
                        var e = CKEDITOR.tools.getNextId(), k = ['\x3cspan id\x3d"', e, '" class\x3d"cke_voice_label"\x3e', d.lang.toolbar.toolbars, "\x3c/span\x3e", '\x3cspan id\x3d"' + d.ui.spaceId("toolbox") + '" class\x3d"cke_toolbox" role\x3d"group" aria-labelledby\x3d"', e, '" onmousedown\x3d"return false;"\x3e'], e = !1 !== d.config.toolbarStartupExpanded, g, l;
                        ...
                        for (var v = d.toolbox.toolbars, r = a(d), q = 0; q < r.length; q++) {
                            var t, p = 0, w, z = r[q], A;
                            if (z)if (g && (k.push("\x3c/span\x3e"), l = g = 0), "/" === z) k.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e'); else {
                                A = z.items || z;
                                    ...
                                    if (x) {
                                        ...
                                        if (x.type == CKEDITOR.UI_SEPARATOR) l = g && x; else {
                                            ...
                                            if (!p) {
                                                ...
                                                k.push('\x3cspan id\x3d"', t, '" class\x3d"cke_toolbar"', w ? ' aria-labelledby\x3d"' + t + '_label"' : "", ' role\x3d"toolbar"\x3e');
                                                w && k.push('\x3cspan id\x3d"', t, '_label" class\x3d"cke_voice_label"\x3e', w, "\x3c/span\x3e");
                                                k.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');
                                                var B = v.push(p) - 1;
                                                0 < B && (p.previous = v[B - 1], p.previous.next = p)
                                            }
                                            D ? g || (k.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'),
        ...
        CKEDITOR.plugins.add("undo", {
            init: function (c) {
                ...
                var g = c.undoManager = new b(c), m = g.editingHandler = new l(g), v = c.addCommand("undo", {
                    exec: function () {
                ...
                g.onChange = function () {
                    ...
                    r.setState(g.redoable() ? CKEDITOR.TRISTATE_OFF :
                        CKEDITOR.TRISTATE_DISABLED)
                };
        ...
        b.prototype =
            {
                ...
                m.splice(this.index + 1, m.length - this.index - 1);
                m.length == this.limit && m.shift();
                this.index = m.push(b) - 1;
                this.currentImage = b;
        ...
        function a(a) {
            ...
            if (CKEDITOR.env.webkit || CKEDITOR.env.ie &&
                10 < CKEDITOR.env.version) f.getDocumentElement().on("mousedown", function (a) {
        ...
        function b() {
            ...
            } else CKEDITOR.env.gecko && (a.push("html{height:100% !important}"),
        ...
        CKEDITOR.plugins.add("wysiwygarea", {
            init: function (a) {
                ...
                a.addMode("wysiwyg", function (b) {
                    ...
                    if (n) {
                        var g = CKEDITOR.tools.getNextId(), v = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + g + '" class\x3d"cke_voice_label"\x3e' + n + "\x3c/span\x3e");
                        f.append(v, 1);
            ...
            $: function () {
                ...
                setData: function (a,
                    ...
                    if (c) this.setHtml(a), this.fixInitialSelection(), e.fire("dataReady"); else {
                        ...
                        h ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e" + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"), n && (a = a.replace(/<head[^>]*?>/, "$\x26" + n)), a = a.replace(/<\/head\s*>/, g + "$\x26"), a = k + a) : a = f.docType + '\x3chtml dir\x3d"' + f.contentsLangDirection +
                                '" lang\x3d"' + (f.contentsLanguage || e.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + n + g + "\x3c/head\x3e\x3cbody" + (f.bodyId ? ' id\x3d"' + f.bodyId + '"' : "") + (f.bodyClass ? ' class\x3d"' + f.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
                        ...
                        f = '\x3cscript id\x3d"cke_actscrpt" type\x3d"text/javascript"' +
                            (CKEDITOR.env.ie ? ' defer\x3d"defer" ' : "") + "\x3evar wasLoaded\x3d0;function onload(){if(!wasLoaded)window.parent.CKEDITOR.tools.callFunction(" + this._.frameLoadedHandler + ",window);wasLoaded\x3d1;}" + (CKEDITOR.env.ie ? "onload();" : 'document.addEventListener("DOMContentLoaded", onload, false );') + "\x3c/script\x3e";
                        ...
                        n && CKEDITOR.env.ie && 10 > CKEDITOR.env.version &&
                        (f += '\x3cscript id\x3d"cke_basetagscrpt"\x3evar baseTag \x3d document.querySelector( "base" );baseTag.href \x3d baseTag.href;\x3c/script\x3e');
                    ...
                    a = this.editor;
                    var b = a.config, c = b.fullPage, e = c && a.docType, h = c && a.xmlDeclaration, k = this.getDocument(), c = c ? k.getDocumentElement().getOuterHtml() :
                        k.getBody().getHtml();
