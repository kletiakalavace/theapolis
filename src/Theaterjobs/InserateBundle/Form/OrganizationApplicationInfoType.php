 ...
 * @DI\FormType
 */
class OrganizationApplicationInfoType extends AbstractType
{
    /**
    ...
    {
        $builder
            ->add('organisationApplicationInfoText', 'textarea', array(
                    'label' => 'organization.edit.label.applicationInfo',
                    'required' => true
                )
            );
    ...
    {
        return 'tj_inserate_form_organization_application_info';
    }
