 ...
 */
class OrganizationLocationType extends AbstractType
{
    /**
     * (non-PHPdoc)
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('geolocation', 'text', array(
                'required' => false,
                'label' => 'form.label.organization.geolocation',
                'attr' => array('class' => 'map-input')
            ))
            ->add('country', 'text', array(
                'required' => false,
                'label' => 'form.label.organization.country',
                'attr' => array('class' => 'map-input-country')
            ))
            ->add('city', 'text', array(
                'required' => false,
                'label' => 'form.label.organization.city',
    ...
    {
        return 'tj_inserate_form_organization_location';
    }
