 ...
 * @DI\FormType
 */
class OrganizationBudgetsType extends AbstractType
{
    /**
    ...
    {
        $builder
            ->add('organizationGrants', 'collection', array(
                'label' => false,
                'required' => false,
                'type' => 'tj_inserate_organization_grants_type',
                'allow_delete' => true,
                'allow_add' => true,
                'prototype' => true,
                'by_reference' => false,
    ...
    {
        return 'tj_inserate_form_organization_budgets';
    }
