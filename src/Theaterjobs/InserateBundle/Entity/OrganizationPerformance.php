 ...
 *
 * @ORM\Table(name="tj_inserate_organization_performance")
 * @ORM\Entity()
 */
class OrganizationPerformance
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Organization", inversedBy="organizationPerformance")
     ...
     *
     * @var type integer
     * @ORM\Column(name="performance_number", type="decimal",precision=50, nullable=true)
     */
    protected $performanceNumber;
     ...
     * Set visitorsNumber
     *
     * @param integer $performanceNumber
     * @return OrganizationPerformance
     */
    public function setPerformanceNumber($performanceNumber)
    {
     ...
     * @return integer
     */
    public function getPerformanceNumber()
    {
