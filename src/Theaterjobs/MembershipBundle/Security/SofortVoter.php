 ...
 * @DI\Service("theaterjobs_membership.sofort_voter", public=false)
 * @DI\Tag("security.voter")
 */
class SofortVoter extends Voter
{

    const MAKE_PAYMENT = 'make_payment_using_sofort';
    const EXEC_PAYMENT = 'execute_payment_using_sofort';
    const CANCEL_PAYMENT = 'cancel_payment_using_sofort';
