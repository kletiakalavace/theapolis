...
class AutoEmbed {
     ...
     */
    public function parseUrl($url, $AutoEmbed_stubs) {
    ...
    public function getImageURL() {
        ...
        $loopLimit = count($this->_media_id);
    ...
    private function _buildiFrame() {
        ...
        return sprintf('<iframe type="text/html" class="video" src="%s" frameborder="0" allowfullscreen></iframe>', $source);
    }
