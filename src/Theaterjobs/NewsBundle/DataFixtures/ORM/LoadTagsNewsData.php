 ...
 */
class LoadTagsNewsData extends AbstractFixture implements ContainerAwareInterface, OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $path = $kernel->locateResource(
                '@TheaterjobsNewsBundle/DataFixtures/SQL/tags_news.csv'
        );
